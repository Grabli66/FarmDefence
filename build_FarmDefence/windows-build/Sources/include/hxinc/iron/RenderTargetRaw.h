...
HX_DECLARE_STACK_FRAME(_hx_pos_f1afc54f6e3df991_783_new)
...
HXLINE( 794)		( ( ::iron::RenderTargetRaw)(__this) )->is_cubemap = null();
HXLINE( 793)		( ( ::iron::RenderTargetRaw)(__this) )->is_image = null();
HXLINE( 792)		( ( ::iron::RenderTargetRaw)(__this) )->depth = null();
HXLINE( 791)		( ( ::iron::RenderTargetRaw)(__this) )->mipmaps = null();
HXLINE( 790)		( ( ::iron::RenderTargetRaw)(__this) )->depth_buffer = null();
HXLINE( 789)		( ( ::iron::RenderTargetRaw)(__this) )->displayp = null();
HXLINE( 788)		( ( ::iron::RenderTargetRaw)(__this) )->scale = null();
HXLINE( 787)		( ( ::iron::RenderTargetRaw)(__this) )->format = null();
            	}
		...
		::String __ToString() const { return HX_("RenderTargetRaw",c1,24,6a,b2); }
