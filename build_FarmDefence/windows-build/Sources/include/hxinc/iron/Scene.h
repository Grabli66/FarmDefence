...
class HXCPP_CLASS_ATTRIBUTES Scene_obj : public hx::Object
{
	...
	public:
		...
		static void create( ::iron::data::TSceneFormat format, ::Dynamic done);
		...
		static void generateTransform( ::iron::data::TObj object, ::iron::object::Transform transform);
		...
		int uid;
		 ::iron::data::TSceneFormat raw;
		 ::iron::object::Object root;
		 ::iron::object::Object sceneParent;
		...
		::Dynamic getMesh_dyn();
		 ...
		 ::iron::object::LightObject getLight(::String name);
		...
		::Dynamic addMeshObject_dyn();
		 ...
		 ::iron::object::LightObject addLightObject( ::iron::data::LightData data, ::iron::object::Object parent);
		::Dynamic addLightObject_dyn();

		 ::iron::object::CameraObject addCameraObject( ::iron::data::CameraData data, ::iron::object::Object parent);
		::Dynamic addCameraObject_dyn();

		 ::iron::object::SpeakerObject addSpeakerObject( ::iron::data::TSpeakerData data, ::iron::object::Object parent);
		...
		::Dynamic parseObject_dyn();
		 ...
		 ::iron::data::TObj getObj( ::iron::data::TSceneFormat format,::String name);
		::Dynamic getObj_dyn();

		 ::iron::data::TObj traverseObjs(::Array< ::Dynamic> children,::String name);
		::Dynamic traverseObjs_dyn();

		void createObject( ::iron::data::TObj o, ::iron::data::TSceneFormat format, ::iron::object::Object parent, ::iron::data::TObj parentObject, ::Dynamic done);
		::Dynamic createObject_dyn();

		::Array< ::String > getGroupObjectRefs(::String group_ref);
		::Dynamic getGroupObjectRefs_dyn();

		bool isLod( ::iron::data::TObj raw);
		::Dynamic isLod_dyn();

		void returnMeshObject(::String object_file,::String data_ref,::String sceneName, ::iron::data::Armature armature,::Array< ::Dynamic> materials, ::iron::object::Object parent, ::iron::data::TObj o, ::Dynamic done);
		::Dynamic returnMeshObject_dyn();

		void returnObject( ::iron::object::Object object, ::iron::data::TObj o, ::Dynamic done);
		::Dynamic returnObject_dyn();

		void returnObjectLoaded( ::iron::object::Object object, ::iron::data::TObj o,::Array< ::Dynamic> oactions, ::Dynamic done);
