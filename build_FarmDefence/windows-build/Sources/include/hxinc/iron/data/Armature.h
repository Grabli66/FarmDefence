...
class HXCPP_CLASS_ATTRIBUTES Armature_obj : public hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("Armature",99,60,28,c6); }

		static void setParents( ::iron::data::TObj object);
		...
		static void traverseBonesStep( ::iron::data::TObj object, ::Dynamic callback);
