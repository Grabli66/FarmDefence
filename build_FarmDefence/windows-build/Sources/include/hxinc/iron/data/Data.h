...
HX_DECLARE_STACK_FRAME(_hx_pos_514b96931615595e_30_new)
			...
			*(void **)__this = Data_obj::_hx_vtable;
{
		...
		static  ::haxe::ds::StringMap cachedLights;
		...
		static  ::haxe::ds::StringMap loadingLights;
		static void getLight(::String file,::String name, ::Dynamic done);
		static ::Dynamic getLight_dyn();
		...
		static void getShader(::String file,::String name, ::Dynamic done, ::iron::data::TShaderOverride overrideContext);
		...
		static void returnSceneRaw(::String file, ::iron::data::TSceneFormat parsed);
		static ::Dynamic returnSceneRaw_dyn();

		static  ::iron::data::TMeshData getMeshRawByName(::Array< ::Dynamic> datas,::String name);
		static ::Dynamic getMeshRawByName_dyn();

		static  ::iron::data::TLightData getLightRawByName(::Array< ::Dynamic> datas,::String name);
		static ::Dynamic getLightRawByName_dyn();

		static  ::iron::data::TCameraData getCameraRawByName(::Array< ::Dynamic> datas,::String name);
		static ::Dynamic getCameraRawByName_dyn();

		static  ::iron::data::TMaterialData getMaterialRawByName(::Array< ::Dynamic> datas,::String name);
		static ::Dynamic getMaterialRawByName_dyn();

		static  ::iron::data::TParticleData getParticleRawByName(::Array< ::Dynamic> datas,::String name);
		static ::Dynamic getParticleRawByName_dyn();

		static  ::iron::data::TWorldData getWorldRawByName(::Array< ::Dynamic> datas,::String name);
		static ::Dynamic getWorldRawByName_dyn();

		static  ::iron::data::TShaderData getShaderRawByName(::Array< ::Dynamic> datas,::String name);
		static ::Dynamic getShaderRawByName_dyn();

		static  ::iron::data::TSpeakerData getSpeakerRawByName(::Array< ::Dynamic> datas,::String name);
