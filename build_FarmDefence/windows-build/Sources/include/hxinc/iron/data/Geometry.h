...
class HXCPP_CLASS_ATTRIBUTES Geometry_obj : public hx::Object
{
	...
	public:
		...
		int instanceCount;
		 ...
		 ::kha::arrays::Float32ArrayPrivate instancedData;
		 ::Dynamic instancedType;
		 ::iron::math::Vec4 aabb;
		...
		void setupInstanced( ::kha::arrays::Float32ArrayPrivate data,int instancedType, ::kha::graphics4::Usage usage);
		::Dynamic setupInstanced_dyn();

		void copyVertices( ::kha::arrays::Float32ArrayPrivate vertices,hx::Null< int >  offset,hx::Null< bool >  fakeUVs);
