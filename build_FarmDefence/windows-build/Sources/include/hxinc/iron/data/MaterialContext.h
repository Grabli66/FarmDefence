...
class HXCPP_CLASS_ATTRIBUTES MaterialContext_obj : public hx::Object
{
	...
	public:
		...
		void __construct( ::iron::data::TMaterialContext raw, ::Dynamic done);
		...
		static hx::ObjectPtr< MaterialContext_obj > __new( ::iron::data::TMaterialContext raw, ::Dynamic done);
		static hx::ObjectPtr< MaterialContext_obj > __alloc(hx::Ctx *_hx_ctx, ::iron::data::TMaterialContext raw, ::Dynamic done);
		...
		::String __ToString() const { return HX_("MaterialContext",e8,5b,3b,56); }

		static void __boot();
		static int num;
		 ::iron::data::TMaterialContext raw;
