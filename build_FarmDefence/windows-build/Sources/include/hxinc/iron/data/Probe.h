...
class HXCPP_CLASS_ATTRIBUTES Probe_obj : public hx::Object
{
	...
	public:
		...
		void __construct( ::iron::data::TProbe raw, ::Dynamic done);
		...
		static hx::ObjectPtr< Probe_obj > __new( ::iron::data::TProbe raw, ::Dynamic done);
		static hx::ObjectPtr< Probe_obj > __alloc(hx::Ctx *_hx_ctx, ::iron::data::TProbe raw, ::Dynamic done);
		...
		::String __ToString() const { return HX_("Probe",10,4b,bd,5b); }

		 ::iron::data::TProbe raw;
		 ::kha::Image radiance;
