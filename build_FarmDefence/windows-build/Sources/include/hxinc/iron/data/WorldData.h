...
class HXCPP_CLASS_ATTRIBUTES WorldData_obj : public  ::iron::data::Data_obj
{
	...
	public:
		...
		void __construct( ::iron::data::TWorldData raw, ::Dynamic done);
		...
		static hx::ObjectPtr< WorldData_obj > __new( ::iron::data::TWorldData raw, ::Dynamic done);
		static hx::ObjectPtr< WorldData_obj > __alloc(hx::Ctx *_hx_ctx, ::iron::data::TWorldData raw, ::Dynamic done);
		...
		::String __ToString() const { return HX_("WorldData",7c,89,52,f1); }
