...
class HXCPP_CLASS_ATTRIBUTES Math_obj : public hx::Object
{
	...
	public:
		...
		static int mapInt(int value,int leftMin,int leftMax,int rightMin,int rightMax);
		static ::Dynamic mapInt_dyn();

		static Float mapClamped(Float value,Float leftMin,Float leftMax,Float rightMin,Float rightMax);
		static ::Dynamic mapClamped_dyn();
