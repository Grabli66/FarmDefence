...
class HXCPP_CLASS_ATTRIBUTES Animation_obj : public hx::Object
{
	...
	public:
		...
		static  ::iron::math::Vec4 vp;
		static  ::iron::math::Vec4 vs;
		bool isSkinned;
		bool isSampled;
		::String action;
		...
		virtual void blend(::String action1,::String action2,float factor);
		::Dynamic blend_dyn();
		...
		virtual bool isTrackEnd( ::iron::data::TTrack track);
		::Dynamic isTrackEnd_dyn();

		bool checkFrameIndex( ::kha::arrays::Uint32ArrayPrivate frameValues);
		::Dynamic checkFrameIndex_dyn();

		void rewind( ::iron::data::TTrack track);
		::Dynamic rewind_dyn();

		void updateTrack( ::iron::data::TAnimation anim);
		::Dynamic updateTrack_dyn();

		void updateAnimSampled( ::iron::data::TAnimation anim, ::iron::math::Mat4 m);
