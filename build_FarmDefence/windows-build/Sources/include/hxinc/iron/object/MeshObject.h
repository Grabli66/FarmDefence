...
class HXCPP_CLASS_ATTRIBUTES MeshObject_obj : public  ::iron::object::Object_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("MeshObject",ac,f0,d9,ef); }

		static void __boot();
		static  ::kha::graphics4::PipelineState lastPipeline;
		...
		void setupParticleSystem(::String sceneName, ::iron::data::TParticleReference pref);
		...
		bool cullMesh(::String context, ::iron::object::CameraObject camera, ::iron::object::LightObject light);
		...
		void render(::Dynamic g,::String context, ::iron::object::CameraObject camera, ::iron::object::LightObject light,::Array< ::String > bindParams);
		::Dynamic render_dyn();
