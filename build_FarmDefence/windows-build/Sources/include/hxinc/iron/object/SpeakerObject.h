...
class HXCPP_CLASS_ATTRIBUTES SpeakerObject_obj : public  ::iron::object::Object_obj
{
	...
	public:
		...
		void __construct( ::iron::data::TSpeakerData data);
		...
		static hx::ObjectPtr< SpeakerObject_obj > __new( ::iron::data::TSpeakerData data);
		static hx::ObjectPtr< SpeakerObject_obj > __alloc(hx::Ctx *_hx_ctx, ::iron::data::TSpeakerData data);
		...
		::String __ToString() const { return HX_("SpeakerObject",fe,20,51,9f); }

		 ::iron::data::TSpeakerData data;
		 ::kha::Sound sound;
