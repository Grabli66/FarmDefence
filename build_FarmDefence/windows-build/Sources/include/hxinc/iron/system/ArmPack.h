...
class HXCPP_CLASS_ATTRIBUTES ArmPack_obj : public hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("ArmPack",35,87,7a,1b); }

		static  ::Dynamic decode( ::haxe::io::Bytes b);
		static ::Dynamic decode_dyn();

		static  ::Dynamic read( ::haxe::io::BytesInput i,::String key,::String parentKey);
		static ::Dynamic read_dyn();

		static  ::Dynamic readArray( ::haxe::io::BytesInput i,int length,::String key,::String parentKey);
		static ::Dynamic readArray_dyn();

		static  ::Dynamic readMap( ::haxe::io::BytesInput i,int length,::String key,::String parentKey);
		static ::Dynamic readMap_dyn();

		static hx::Class getClass(::String key,::String parentKey);
