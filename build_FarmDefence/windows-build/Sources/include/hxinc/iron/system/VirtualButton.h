...
HX_DECLARE_STACK_FRAME(_hx_pos_0070f08c40120be8_86_new)
...
HXLINE(  89)		( ( ::iron::_hx_system::VirtualButton)(__this) )->down = false;
HXLINE(  88)		( ( ::iron::_hx_system::VirtualButton)(__this) )->released = false;
HXLINE(  87)		( ( ::iron::_hx_system::VirtualButton)(__this) )->started = false;
            	}
		...
		::String __ToString() const { return HX_("VirtualButton",3d,5e,ed,98); }
