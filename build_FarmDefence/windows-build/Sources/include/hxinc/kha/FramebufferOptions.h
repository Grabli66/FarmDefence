...
{
 ::Dynamic frequency = __o_frequency.Default(60);
 ::Dynamic verticalSync = __o_verticalSync.Default(true);
 ::Dynamic colorBufferBits = __o_colorBufferBits.Default(32);
 ::Dynamic depthBufferBits = __o_depthBufferBits.Default(16);
 ::Dynamic stencilBufferBits = __o_stencilBufferBits.Default(8);
 ::Dynamic samplesPerPixel = __o_samplesPerPixel.Default(1);
