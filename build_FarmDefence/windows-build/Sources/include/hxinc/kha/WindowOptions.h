...
class HXCPP_CLASS_ATTRIBUTES WindowOptions_obj : public hx::Object
{
	...
	public:
		...
		void __construct(::String title, ::Dynamic __o_x, ::Dynamic __o_y, ::Dynamic __o_width, ::Dynamic __o_height, ::kha::Display display, ::Dynamic __o_visible, ::Dynamic __o_windowFeatures, ::Dynamic __o_mode);
		...
		static hx::ObjectPtr< WindowOptions_obj > __new(::String title, ::Dynamic __o_x, ::Dynamic __o_y, ::Dynamic __o_width, ::Dynamic __o_height, ::kha::Display display, ::Dynamic __o_visible, ::Dynamic __o_windowFeatures, ::Dynamic __o_mode);
		static hx::ObjectPtr< WindowOptions_obj > __alloc(hx::Ctx *_hx_ctx,::String title, ::Dynamic __o_x, ::Dynamic __o_y, ::Dynamic __o_width, ::Dynamic __o_height, ::kha::Display display, ::Dynamic __o_visible, ::Dynamic __o_windowFeatures, ::Dynamic __o_mode);
