...
HXLINE(   9)			::armory::data::Config_obj::raw =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,blob->toString())->doParse();
HXLINE(  10)			done();
            		}
...
HXLINE(  15)		::String path = (::iron::data::Data_obj::dataPath + HX_("config.arm",b0,ae,23,61));
HXLINE(  16)		 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofString(::haxe::format::JsonPrinter_obj::print(::armory::data::Config_obj::raw,null(),null()));
HXLINE(  20)		::sys::io::File_obj::saveBytes(path,bytes);
            	}
...
static hx::StaticInfo Config_obj_sStaticStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(void *) &Config_obj::raw,HX_("raw",e8,d5,56,00)},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void Config_obj::__register()
{
	...
	__mClass->mName = HX_("armory.data.Config",52,37,79,14);
