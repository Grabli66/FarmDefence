...
HX_DEFINE_STACK_FRAME(_hx_pos_11dd17fa9530c2a7_45_new,"haxe.ds.List","new",0x82be24e7,"haxe.ds.List.new","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/ds/List.hx",45,0xa200ee41)
HX_LOCAL_STACK_FRAME(_hx_pos_11dd17fa9530c2a7_53_add,"haxe.ds.List","add",0x82b446a8,"haxe.ds.List.add","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/ds/List.hx",53,0xa200ee41)
HX_LOCAL_STACK_FRAME(_hx_pos_11dd17fa9530c2a7_162_iterator,"haxe.ds.List","iterator",0x056d2c07,"haxe.ds.List.iterator","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/ds/List.hx",162,0xa200ee41)
namespace haxe{
namespace ds{

void List_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_11dd17fa9530c2a7_45_new)
...
void List_obj::add( ::Dynamic item){
            	HX_GC_STACKFRAME(&_hx_pos_11dd17fa9530c2a7_53_add)
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,add,(void))
 ...
 ::haxe::ds::_List::ListIterator List_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_11dd17fa9530c2a7_162_iterator)
