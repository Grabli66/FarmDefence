...
HX_DEFINE_STACK_FRAME(_hx_pos_db416652fb2468db_270_new,"haxe.ds._List.ListIterator","new",0x2a47d966,"haxe.ds._List.ListIterator.new","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/ds/List.hx",270,0xa200ee41)
HX_LOCAL_STACK_FRAME(_hx_pos_db416652fb2468db_274_hasNext,"haxe.ds._List.ListIterator","hasNext",0x5bdaa973,"haxe.ds._List.ListIterator.hasNext","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/ds/List.hx",274,0xa200ee41)
HX_LOCAL_STACK_FRAME(_hx_pos_db416652fb2468db_277_next,"haxe.ds._List.ListIterator","next",0xd496612d,"haxe.ds._List.ListIterator.next","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/ds/List.hx",277,0xa200ee41)
namespace haxe{
namespace ds{
namespace _List{

void ListIterator_obj::__construct( ::haxe::ds::_List::ListNode head){
            	HX_STACKFRAME(&_hx_pos_db416652fb2468db_270_new)
HXDLIN( 270)		this->head = head;
            	}
...
bool ListIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_db416652fb2468db_274_hasNext)
HXDLIN( 274)		return hx::IsNotNull( this->head );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ListIterator_obj,hasNext,return )
 ...
 ::Dynamic ListIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_db416652fb2468db_277_next)
HXLINE( 278)		 ::Dynamic val = this->head->item;
HXLINE( 279)		this->head = this->head->next;
