...
HX_DEFINE_STACK_FRAME(_hx_pos_53e558d60246933d_256_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/ds/List.hx",256,0xa200ee41)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_53e558d60246933d_256_new)
HXLINE( 257)		this->item = item;
HXLINE( 258)		this->next = next;
            	}
