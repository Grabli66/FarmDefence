...
HX_DEFINE_STACK_FRAME(_hx_pos_3cc150739f7e7363_51_new,"haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/format/JsonParser.hx",51,0x05afde00)
HX_LOCAL_STACK_FRAME(_hx_pos_3cc150739f7e7363_56_doParse,"haxe.format.JsonParser","doParse",0xa959e310,"haxe.format.JsonParser.doParse","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/format/JsonParser.hx",56,0x05afde00)
HX_LOCAL_STACK_FRAME(_hx_pos_3cc150739f7e7363_71_parseRec,"haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/format/JsonParser.hx",71,0x05afde00)
HX_LOCAL_STACK_FRAME(_hx_pos_3cc150739f7e7363_152_parseString,"haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/format/JsonParser.hx",152,0x05afde00)
HX_LOCAL_STACK_FRAME(_hx_pos_3cc150739f7e7363_264_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/format/JsonParser.hx",264,0x05afde00)
HX_LOCAL_STACK_FRAME(_hx_pos_3cc150739f7e7363_270_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/format/JsonParser.hx",270,0x05afde00)
namespace haxe{
namespace format{

void JsonParser_obj::__construct(::String str){
            	HX_STACKFRAME(&_hx_pos_3cc150739f7e7363_51_new)
...
bool JsonParser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JsonParser_obj::doParse(){
            	HX_STACKFRAME(&_hx_pos_3cc150739f7e7363_56_doParse)
...
HX_DEFINE_DYNAMIC_FUNC0(JsonParser_obj,doParse,return )
 ...
 ::Dynamic JsonParser_obj::parseRec(){
            	HX_STACKFRAME(&_hx_pos_3cc150739f7e7363_71_parseRec)
...
HXLINE( 145)							goto _hx_goto_4;
            					...
            					_hx_goto_4:;
HXDLIN( 145)					::String f = this->str;
HXDLIN( 145)					Float f1 = ::Std_obj::parseFloat(f.substr(start,(this->pos - start)));
HXDLIN( 145)					int i = ::Std_obj::_hx_int(f1);
HXDLIN( 145)					if ((i == f1)) {
HXLINE( 145)						return i;
            					}
            					else {
HXLINE( 145)						return f1;
            					}
            				}
            				break;
            				case (int)91: {
...
::String JsonParser_obj::parseString(){
            	HX_GC_STACKFRAME(&_hx_pos_3cc150739f7e7363_152_parseString)
...
HXDLIN( 179)									::Array< char > buf2 = buf->charBuf;
HXDLIN( 179)									buf2->push((192 | (( (int)(uc) ) >> 6)));
            								}
HXLINE( 180)								{
HXLINE( 180)									if (hx::IsNull( buf->charBuf )) {
HXLINE( 180)										buf->charBuf = ::Array_obj< char >::__new();
            									}
HXDLIN( 180)									::Array< char > buf3 = buf->charBuf;
HXDLIN( 180)									buf3->push((128 | (( (int)(uc) ) & 63)));
            								}
            							}
            							else {
...
HXDLIN( 182)										::Array< char > buf4 = buf->charBuf;
HXDLIN( 182)										buf4->push((224 | (( (int)(uc) ) >> 12)));
            									}
HXLINE( 183)									{
HXLINE( 183)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 183)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 183)										::Array< char > buf5 = buf->charBuf;
HXDLIN( 183)										buf5->push((128 | ((( (int)(uc) ) >> 6) & 63)));
            									}
HXLINE( 184)									{
HXLINE( 184)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 184)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 184)										::Array< char > buf6 = buf->charBuf;
HXDLIN( 184)										buf6->push((128 | (( (int)(uc) ) & 63)));
            									}
            								}
            								else {
HXLINE( 186)									{
...
HXDLIN( 186)										::Array< char > buf7 = buf->charBuf;
HXDLIN( 186)										buf7->push((240 | (( (int)(uc) ) >> 18)));
            									}
HXLINE( 187)									{
HXLINE( 187)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 187)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 187)										::Array< char > buf8 = buf->charBuf;
HXDLIN( 187)										buf8->push((128 | ((( (int)(uc) ) >> 12) & 63)));
            									}
HXLINE( 188)									{
HXLINE( 188)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 188)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 188)										::Array< char > buf9 = buf->charBuf;
HXDLIN( 188)										buf9->push((128 | ((( (int)(uc) ) >> 6) & 63)));
            									}
HXLINE( 189)									{
HXLINE( 189)										if (hx::IsNull( buf->charBuf )) {
HXLINE( 189)											buf->charBuf = ::Array_obj< char >::__new();
            										}
HXDLIN( 189)										::Array< char > buf10 = buf->charBuf;
HXDLIN( 189)										buf10->push((128 | (( (int)(uc) ) & 63)));
            									}
            								}
            							}
            						}
            					...
            					break;
            					default:{
HXLINE( 195)						::String _hx_tmp1 = ((HX_("Invalid escape sequence \\",73,af,f7,b2) + ::String::fromCharCode(c)) + HX_(" at position ",0a,c2,01,e0));
HXDLIN( 195)						HX_STACK_DO_THROW((_hx_tmp1 + (this->pos - 1)));
            					}
            				}
...
HXLINE( 202)					this->pos++;
HXLINE( 203)					if ((c >= 252)) {
HXLINE( 203)						 ::haxe::format::JsonParser _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 203)						_hx_tmp2->pos = (_hx_tmp2->pos + 4);
            					}
            					else {
HXLINE( 204)						if ((c >= 248)) {
HXLINE( 204)							 ::haxe::format::JsonParser _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 204)							_hx_tmp3->pos = (_hx_tmp3->pos + 3);
            						}
            						else {
HXLINE( 205)							if ((c >= 240)) {
HXLINE( 205)								 ::haxe::format::JsonParser _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 205)								_hx_tmp4->pos = (_hx_tmp4->pos + 2);
            							}
            							else {
HXLINE( 206)								if ((c >= 224)) {
HXLINE( 206)									this->pos++;
...
HXLINE( 213)			::String _hx_tmp5 = this->str;
HXDLIN( 213)			return _hx_tmp5.substr(start,((this->pos - start) - 1));
            		}
            		else {
HXLINE( 216)			{
...
HXLINE( 216)					::Array< ::String > buf11 = buf->b;
HXDLIN( 216)					buf11->push(s1.substr(start,len1));
            				}
            			}
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_3cc150739f7e7363_264_invalidChar)
HXLINE( 265)		this->pos--;
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_3cc150739f7e7363_270_invalidNumber)
HXDLIN( 270)		::String _hx_tmp = this->str;
HXDLIN( 270)		HX_STACK_DO_THROW((((HX_("Invalid number at position ",d8,9d,6f,13) + start) + HX_(": ",a6,32,00,00)) + _hx_tmp.substr(start,(this->pos - start))));
            	}
