...
HX_DEFINE_STACK_FRAME(_hx_pos_462df1750a12e2a8_816_new,"iron.CachedShaderContext","new",0xa7cfdbb4,"iron.CachedShaderContext.new","iron/RenderPath.hx",816,0x489fbb1c)
namespace iron{

void CachedShaderContext_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_462df1750a12e2a8_816_new)
            	}
...
static hx::StorageInfo CachedShaderContext_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::iron::data::ShaderContext*/ ,(int)offsetof(CachedShaderContext_obj,context),HX_("context",ef,95,77,19)},
	{ hx::fsUnknown, 0, null()}
};
...
{
	CachedShaderContext_obj _hx_dummy;
	CachedShaderContext_obj::_hx_vtable = *(void **)&_hx_dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_("iron.CachedShaderContext",c2,31,6b,a1);
