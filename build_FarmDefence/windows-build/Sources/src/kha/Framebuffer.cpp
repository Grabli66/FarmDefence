...
static hx::StorageInfo Framebuffer_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::kha::graphics1::Graphics*/ ,(int)offsetof(Framebuffer_obj,graphics1),HX_("graphics1",06,b9,91,08)},
	{hx::fsObject /*::kha::graphics2::Graphics*/ ,(int)offsetof(Framebuffer_obj,graphics2),HX_("graphics2",07,b9,91,08)},
	{hx::fsObject /*::kha::graphics4::Graphics*/ ,(int)offsetof(Framebuffer_obj,graphics4),HX_("graphics4",09,b9,91,08)},
	{hx::fsObject /*::kha::graphics5::Graphics*/ ,(int)offsetof(Framebuffer_obj,graphics5),HX_("graphics5",0a,b9,91,08)},
