...
HXDLIN( 390)		int _g1 = 0;
HXDLIN( 390)		int _g = mipmaps->length;
HXDLIN( 390)		while((_g1 < _g)){
HXDLIN( 390)			_g1 = (_g1 + 1);
HXDLIN( 390)			int i = (_g1 - 1);
...
static hx::StorageInfo Image_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::kha::graphics1::Graphics*/ ,(int)offsetof(Image_obj,graphics1),HX_("graphics1",06,b9,91,08)},
	{hx::fsObject /*::kha::graphics2::Graphics*/ ,(int)offsetof(Image_obj,graphics2),HX_("graphics2",07,b9,91,08)},
	{hx::fsObject /*::kha::graphics4::Graphics*/ ,(int)offsetof(Image_obj,graphics4),HX_("graphics4",09,b9,91,08)},
	{hx::fsObject /*::kha::graphics1::Graphics*/ ,(int)offsetof(Image_obj,g1),HX_("g1",ea,59,00,00)},
	{hx::fsObject /*::kha::graphics2::Graphics*/ ,(int)offsetof(Image_obj,g2),HX_("g2",eb,59,00,00)},
	{hx::fsObject /*::kha::graphics4::Graphics*/ ,(int)offsetof(Image_obj,g4),HX_("g4",ed,59,00,00)},
