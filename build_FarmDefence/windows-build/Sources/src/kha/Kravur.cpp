...
HXLINE( 150)			::kha::KravurImage_obj::gaps = ::Array_obj< int >::__new(1)->init(0,glyphs->__get(0));
HXLINE( 151)			int next = (::kha::KravurImage_obj::gaps->__get(0) + 1);
HXLINE( 152)			{
HXLINE( 152)				int _g1 = 1;
HXDLIN( 152)				int _g = glyphs->length;
HXDLIN( 152)				while((_g1 < _g)){
HXLINE( 152)					_g1 = (_g1 + 1);
HXDLIN( 152)					int i = (_g1 - 1);
HXLINE( 153)					if ((glyphs->__get(i) != next)) {
HXLINE( 154)						::Array< int > _hx_tmp = ::kha::KravurImage_obj::gaps;
HXDLIN( 154)						_hx_tmp->push(glyphs->__get((i - 1)));
HXLINE( 155)						::Array< int > _hx_tmp1 = ::kha::KravurImage_obj::gaps;
HXDLIN( 155)						_hx_tmp1->push(glyphs->__get(i));
HXLINE( 156)						next = (glyphs->__get(i) + 1);
            					}
            					else {
HXLINE( 157)						next = (next + 1);
            					}
            				}
            			}
HXLINE( 159)			::Array< int > _hx_tmp2 = ::kha::KravurImage_obj::gaps;
HXDLIN( 159)			_hx_tmp2->push(glyphs->__get((glyphs->length - 1)));
            		}
...
HXLINE( 173)			int status = -1;
HXLINE( 174)			while((status <= 0)){
HXLINE( 175)				if ((height < width)) {
HXLINE( 175)					height = (height * 2);
            				}
            				else {
HXLINE( 176)					width = (width * 2);
            				}
HXLINE( 177)				pixels = ::kha::internal::BytesBlob_obj::alloc((width * height));
HXLINE( 178)				status = ::kha::graphics2::truetype::StbTruetype_obj::stbtt_BakeFontBitmap(this->blob,0,( (Float)(fontSize) ),pixels,width,height,glyphs,baked);
            			}
HXLINE( 183)			 ::kha::graphics2::truetype::Stbtt_fontinfo info =  ::kha::graphics2::truetype::Stbtt_fontinfo_obj::__alloc( HX_CTX );
HXLINE( 184)			::kha::graphics2::truetype::StbTruetype_obj::stbtt_InitFont(info,this->blob,0);
...
HXLINE( 187)			Float scale = ::kha::graphics2::truetype::StbTruetype_obj::stbtt_ScaleForPixelHeight(info,( (Float)(fontSize) ));
...
HXLINE( 192)			 ::kha::KravurImage image =  ::kha::KravurImage_obj::__alloc( HX_CTX ,::Std_obj::_hx_int(( (Float)(fontSize) )),ascent,descent,lineGap,width,height,baked,pixels);
HXLINE( 193)			this->images->set(imageIndex,image);
HXLINE( 194)			return image;
            		}
HXLINE( 196)		return ( ( ::kha::KravurImage)(this->images->get(imageIndex)) );
            	}
