...
HXLINE(  89)		int offset = ::kha::KravurImage_obj::gaps->__get(0);
...
HXLINE(  92)		{
HXLINE(  92)			int _g1 = 1;
HXDLIN(  92)			int _g = ::Std_obj::_hx_int((( (Float)(::kha::KravurImage_obj::gaps->length) ) / ( (Float)(2) )));
HXDLIN(  92)			while((_g1 < _g)){
HXLINE(  92)				_g1 = (_g1 + 1);
HXDLIN(  92)				int i = (_g1 - 1);
HXLINE(  93)				::Array< int > prevEnd = ::kha::KravurImage_obj::gaps;
HXDLIN(  93)				int prevEnd1 = prevEnd->__get(((i * 2) - 1));
HXLINE(  94)				::Array< int > start = ::kha::KravurImage_obj::gaps;
HXDLIN(  94)				int start1 = start->__get((i * 2));
HXLINE(  95)				if ((charIndex > (start1 - 1))) {
HXLINE(  95)					offset = (offset + ((start1 - 1) - prevEnd1));
            				}
            			}
            		}
...
HXLINE( 108)		Float width = ( (Float)(0) );
HXLINE( 109)		{
...
static hx::StaticInfo KravurImage_obj_sStaticStorageInfo[] = {
	{hx::fsObject /*Array< int >*/ ,(void *) &KravurImage_obj::gaps,HX_("gaps",9d,f6,5e,44)},
	{ hx::fsUnknown, 0, null()}
};
#endif
