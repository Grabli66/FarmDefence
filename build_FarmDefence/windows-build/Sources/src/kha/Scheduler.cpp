...
HXDLIN( 152)				_hx_tmp->remove(::kha::Scheduler_obj::timeTasksScratchpad->__get(0).StaticCast<  ::kha::TimeTask >());
            			}
            		}
            		else {
...
HXDLIN( 198)							int _g = (::kha::Scheduler_obj::DIF_COUNT - 2);
HXDLIN( 198)							while((_g1 < _g)){
HXLINE( 198)								_g1 = (_g1 + 1);
HXDLIN( 198)								int i = (_g1 - 1);
...
HXDLIN( 260)				_hx_tmp7->remove(::kha::Scheduler_obj::timeTasksScratchpad->__get(0).StaticCast<  ::kha::TimeTask >());
            			}
            		}
HXLINE( 264)		::kha::Scheduler_obj::sortFrameTasks();
HXLINE( 265)		{
HXLINE( 265)			int _g8 = 0;
...
HXDLIN( 481)			_hx_tmp->remove(::kha::Scheduler_obj::timeTasksScratchpad->__get(0).StaticCast<  ::kha::TimeTask >());
            		}
