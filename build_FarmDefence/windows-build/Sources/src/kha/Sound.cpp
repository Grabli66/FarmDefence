...
HXDLIN(  32)						 float32array this3 = this2->self;
HXDLIN(  32)						this3.set((i * 2),value);
            					}
HXLINE(  33)					{
HXLINE(  33)						 ::kha::arrays::Float32ArrayPrivate this4 = this->uncompressedData;
...
HXDLIN(  33)						 float32array this5 = this4->self;
HXDLIN(  33)						this5.set(((i * 2) + 1),value1);
            					}
            				}
            			}
            		}
            		else {
HXLINE(  37)			 ::kha::arrays::Float32ArrayPrivate this6 =  ::kha::arrays::Float32ArrayPrivate_obj::__alloc( HX_CTX ,count);
HXDLIN(  37)			this->uncompressedData = this6;
HXLINE(  38)			{
HXLINE(  38)				int _g11 = 0;
HXDLIN(  38)				int _g2 = count;
HXDLIN(  38)				while((_g11 < _g2)){
HXLINE(  38)					_g11 = (_g11 + 1);
HXDLIN(  38)					int i1 = (_g11 - 1);
HXLINE(  39)					{
HXLINE(  39)						 ::kha::arrays::Float32ArrayPrivate this7 = this->uncompressedData;
...
HXDLIN(  39)						this7->self.set(i1,value2);
            					}
            				}
            			}
            		}
