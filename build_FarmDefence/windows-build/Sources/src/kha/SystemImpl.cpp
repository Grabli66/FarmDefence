...
HXDLIN( 288)		 ::kha::input::Keyboard _hx_tmp = ::kha::SystemImpl_obj::keyboard;
HXDLIN( 288)		_hx_tmp->sendPressEvent(::String::fromCharCode(_hx_char));
            	}
...
static hx::StaticInfo SystemImpl_obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*cpp::ArrayBase*/ ,(void *) &SystemImpl_obj::mouseLockListeners,HX_("mouseLockListeners",af,da,5c,62)},
