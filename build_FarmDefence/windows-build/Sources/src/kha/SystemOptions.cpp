...
HX_DEFINE_STACK_FRAME(_hx_pos_c5c1faf3324daaa6_4_new,"kha.SystemOptions","new",0x1e7305b7,"kha.SystemOptions.new","kha/System.hx",4,0xeb7aee24)
namespace kha{
...
::String title = __o_title.Default(HX_("Kha",04,44,39,00));
 ::Dynamic width = __o_width.Default(-1);
 ::Dynamic height = __o_height.Default(-1);
            	HX_GC_STACKFRAME(&_hx_pos_c5c1faf3324daaa6_4_new)
HXLINE(   9)		this->framebuffer = null();
HXLINE(   8)		this->window = null();
HXLINE(   7)		this->height = -1;
HXLINE(   6)		this->width = -1;
HXLINE(   5)		this->title = HX_("Kha",04,44,39,00);
HXLINE(  21)		this->title = title;
HXLINE(  22)		 ::kha::WindowOptions _hx_tmp;
HXDLIN(  22)		if (hx::IsNull( window )) {
HXLINE(  22)			_hx_tmp =  ::kha::WindowOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null());
            		}
            		else {
HXLINE(  22)			_hx_tmp = window;
            		}
HXDLIN(  22)		this->window = _hx_tmp;
HXLINE(  24)		if (hx::IsGreater( width,0 )) {
HXLINE(  25)			this->window->width = ( (int)(width) );
HXLINE(  26)			this->width = ( (int)(width) );
            		}
            		else {
HXLINE(  29)			this->width = this->window->width;
            		}
HXLINE(  32)		if (hx::IsGreater( height,0 )) {
HXLINE(  33)			this->window->height = ( (int)(height) );
HXLINE(  34)			this->height = ( (int)(height) );
            		}
            		else {
HXLINE(  37)			this->height = this->window->height;
            		}
HXLINE(  40)		if (hx::IsNull( this->window->title )) {
HXLINE(  41)			this->window->title = title;
            		}
HXLINE(  44)		 ::kha::FramebufferOptions _hx_tmp1;
HXDLIN(  44)		if (hx::IsNull( framebuffer )) {
HXLINE(  44)			_hx_tmp1 =  ::kha::FramebufferOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            		}
            		else {
HXLINE(  44)			_hx_tmp1 = framebuffer;
            		}
HXDLIN(  44)		this->framebuffer = _hx_tmp1;
            	}
