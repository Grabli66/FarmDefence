...
HXDLIN(  42)		int _hx_tmp = (::Std_obj::_hx_int(( (Float)((a * 255)) )) << 24);
HXDLIN(  42)		int _hx_tmp1 = (_hx_tmp | (::Std_obj::_hx_int(( (Float)((r * 255)) )) << 16));
HXDLIN(  42)		int _hx_tmp2 = (_hx_tmp1 | (::Std_obj::_hx_int(( (Float)((g * 255)) )) << 8));
HXDLIN(  42)		return ::kha::_Color::Color_Impl__obj::_new((_hx_tmp2 | ::Std_obj::_hx_int(( (Float)((b * 255)) ))));
            	}
...
HXDLIN( 149)		return (hx::UShr((this1 & 16711680),16) * ( (float)(((Float)0.00392156862745098)) ));
            	}
...
HXDLIN( 153)		return (hx::UShr((this1 & 65280),8) * ( (float)(((Float)0.00392156862745098)) ));
            	}
...
HXDLIN( 157)		return ((this1 & 255) * ( (float)(((Float)0.00392156862745098)) ));
            	}
...
HXDLIN( 161)		return (hx::UShr(this1,24) * ( (float)(((Float)0.00392156862745098)) ));
            	}
...
HXLINE( 165)		int this2 = (::Std_obj::_hx_int(( (Float)(((hx::UShr(this1,24) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )) << 24);
HXDLIN( 165)		int this3 = (this2 | (::Std_obj::_hx_int(( (Float)((f * 255)) )) << 16));
HXDLIN( 165)		int this4 = (this3 | (::Std_obj::_hx_int(( (Float)(((hx::UShr((this1 & 65280),8) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )) << 8));
HXDLIN( 165)		this1 = (this4 | ::Std_obj::_hx_int(( (Float)((((this1 & 255) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )));
HXLINE( 166)		return f;
            	}
...
HXLINE( 170)		int this2 = (::Std_obj::_hx_int(( (Float)(((hx::UShr(this1,24) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )) << 24);
HXDLIN( 170)		int this3 = (this2 | (::Std_obj::_hx_int(( (Float)(((hx::UShr((this1 & 16711680),16) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )) << 16));
HXDLIN( 170)		int this4 = (this3 | (::Std_obj::_hx_int(( (Float)((f * 255)) )) << 8));
HXDLIN( 170)		this1 = (this4 | ::Std_obj::_hx_int(( (Float)((((this1 & 255) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )));
HXLINE( 171)		return f;
            	}
...
HXLINE( 175)		int this2 = (::Std_obj::_hx_int(( (Float)(((hx::UShr(this1,24) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )) << 24);
HXDLIN( 175)		int this3 = (this2 | (::Std_obj::_hx_int(( (Float)(((hx::UShr((this1 & 16711680),16) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )) << 16));
HXDLIN( 175)		int this4 = (this3 | (::Std_obj::_hx_int(( (Float)(((hx::UShr((this1 & 65280),8) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )) << 8));
HXDLIN( 175)		this1 = (this4 | ::Std_obj::_hx_int(( (Float)((f * 255)) )));
HXLINE( 176)		return f;
            	}
...
HXLINE( 180)		int this2 = (::Std_obj::_hx_int(( (Float)((f * 255)) )) << 24);
HXDLIN( 180)		int this3 = (this2 | (::Std_obj::_hx_int(( (Float)(((hx::UShr((this1 & 16711680),16) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )) << 16));
HXDLIN( 180)		int this4 = (this3 | (::Std_obj::_hx_int(( (Float)(((hx::UShr((this1 & 65280),8) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )) << 8));
HXDLIN( 180)		this1 = (this4 | ::Std_obj::_hx_int(( (Float)((((this1 & 255) * ( (float)(((Float)0.00392156862745098)) )) * 255)) )));
HXLINE( 181)		return f;
            	}
...
static hx::StaticInfo Color_Impl__obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::cpp::Float32*/ ,(void *) &Color_Impl__obj::invMaxChannelValue,HX_("invMaxChannelValue",81,3a,08,e4)},
	{ hx::fsUnknown, 0, null()}
};
#endif
