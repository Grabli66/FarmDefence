...
HXDLIN(  34)				if (hx::IsGreaterEq( code,HX_("a",61,00,00,00).charCodeAt(0) )) {
HXLINE(  34)					_hx_tmp = hx::IsLessEq( code,HX_("z",7a,00,00,00).charCodeAt(0) );
            				}
            				else {
HXLINE(  34)					_hx_tmp = false;
            				}
HXDLIN(  34)				if (_hx_tmp) {
HXLINE(  35)					int c = (code - HX_("a",61,00,00,00).charCodeAt(0));
HXDLIN(  35)					int c1 = (c + HX_("A",41,00,00,00).charCodeAt(0));
HXDLIN(  35)					{
HXLINE(  35)						if (hx::IsNull( buffer->charBuf )) {
...
HXLINE(  37)					if ((code == ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\xa4""",81,aa,00,00),0))) {
HXLINE(  38)						int c2 = ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\x84""",61,aa,00,00),0);
HXDLIN(  38)						{
HXLINE(  38)							if (hx::IsNull( buffer->charBuf )) {
...
HXLINE(  40)						if ((code == ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\xb6""",93,aa,00,00),0))) {
HXLINE(  41)							int c3 = ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\x96""",73,aa,00,00),0);
HXDLIN(  41)							{
HXLINE(  41)								if (hx::IsNull( buffer->charBuf )) {
...
HXLINE(  43)							if ((code == ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\xbc""",99,aa,00,00),0))) {
HXLINE(  44)								int c4 = ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\x9c""",79,aa,00,00),0);
HXDLIN(  44)								{
HXLINE(  44)									if (hx::IsNull( buffer->charBuf )) {
...
HXDLIN(  56)				if (hx::IsGreaterEq( code,HX_("A",41,00,00,00).charCodeAt(0) )) {
HXLINE(  56)					_hx_tmp = hx::IsLessEq( code,HX_("Z",5a,00,00,00).charCodeAt(0) );
            				}
            				else {
HXLINE(  56)					_hx_tmp = false;
            				}
HXDLIN(  56)				if (_hx_tmp) {
HXLINE(  57)					int c = (code - HX_("A",41,00,00,00).charCodeAt(0));
HXDLIN(  57)					int c1 = (c + HX_("a",61,00,00,00).charCodeAt(0));
HXDLIN(  57)					{
HXLINE(  57)						if (hx::IsNull( buffer->charBuf )) {
...
HXLINE(  59)					if ((code == ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\x84""",61,aa,00,00),0))) {
HXLINE(  60)						int c2 = ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\xa4""",81,aa,00,00),0);
HXDLIN(  60)						{
HXLINE(  60)							if (hx::IsNull( buffer->charBuf )) {
...
HXLINE(  62)						if ((code == ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\x96""",73,aa,00,00),0))) {
HXLINE(  63)							int c3 = ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\xb6""",93,aa,00,00),0);
HXDLIN(  63)							{
HXLINE(  63)								if (hx::IsNull( buffer->charBuf )) {
...
HXLINE(  65)							if ((code == ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\x9c""",79,aa,00,00),0))) {
HXLINE(  66)								int c4 = ::haxe::Utf8_obj::charCodeAt(HX_("\xc3""\xbc""",99,aa,00,00),0);
HXDLIN(  66)								{
HXLINE(  66)									if (hx::IsNull( buffer->charBuf )) {
...
HXLINE(  97)		int index = -1;
HXLINE(  98)		int i;
HXDLIN(  98)		if (hx::IsNull( startIndex )) {
HXLINE(  98)			i = 0;
            		}
            		else {
HXLINE(  98)			i = ( (int)(startIndex) );
            		}
HXLINE(  99)		{
...
HXLINE( 100)					_hx_tmp = hx::IsEq( str.charCodeAt(0),_hx_char );
            				}
            				else {
...
{
	SuperString_Impl__obj _hx_dummy;
	SuperString_Impl__obj::_hx_vtable = *(void **)&_hx_dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_("kha._SuperString.SuperString_Impl_",15,1d,25,a1);
