...
HXLINE(  55)		{
HXLINE(  55)			int _g2 = 0;
HXDLIN(  55)			while((_g2 < 16)){
HXLINE(  55)				_g2 = (_g2 + 1);
HXDLIN(  55)				int i1 = (_g2 - 1);
HXLINE(  56)				{
...
HXLINE(  58)		{
HXLINE(  58)			int _g3 = 0;
HXDLIN(  58)			while((_g3 < 16)){
HXLINE(  58)				_g3 = (_g3 + 1);
HXDLIN(  58)				int i2 = (_g3 - 1);
HXLINE(  59)				{
...
HXLINE(  68)				{
HXLINE(  68)					int _g31 = 0;
HXDLIN(  68)					int _g21 = samples;
HXDLIN(  68)					while((_g31 < _g21)){
HXLINE(  68)						_g31 = (_g31 + 1);
HXDLIN(  68)						int i3 = (_g31 - 1);
HXLINE(  69)						{
...
HXDLIN(  69)								float value2 = ( (float)((value + (value1 * channel->get_volume()))) );
...
HXLINE(  75)				{
HXLINE(  75)					int _g32 = 0;
HXDLIN(  75)					int _g22 = samples;
HXDLIN(  75)					while((_g32 < _g22)){
HXLINE(  75)						_g32 = (_g32 + 1);
HXDLIN(  75)						int i4 = (_g32 - 1);
HXLINE(  76)						{
...
HXDLIN(  76)								float value5 = ( (float)((value3 + (value4 * channel1->get_volume()))) );
