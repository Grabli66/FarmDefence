...
HXLINE( 103)			{
HXLINE( 103)				int _g11 = 0;
HXDLIN( 103)				int _g2 = segmentCount;
HXDLIN( 103)				while((_g11 < _g2)){
HXLINE( 103)					_g11 = (_g11 + 1);
HXDLIN( 103)					int i3 = (_g11 - 1);
...
HXDLIN( 298)					header->b[i] = ( (unsigned char)(x) );
            				}
            			}
            		}
...
HXDLIN( 330)		{
HXDLIN( 330)			int _g1 = 0;
HXDLIN( 330)			int _g = len;
HXDLIN( 330)			while((_g1 < _g)){
HXDLIN( 330)				_g1 = (_g1 + 1);
HXDLIN( 330)				int i = (_g1 - 1);
HXDLIN( 330)				{
...
HXLINE( 402)			this->discardSamplesDeferred = (n -  ::Dynamic(r->__Field(HX_("right",dc,0b,64,e9),hx::paccDynamic))->__Field(HX_("end",db,03,4d,00),hx::paccDynamic));
...
HXLINE( 422)				int currentEnd = this->knownLocForPacket;
HXDLIN( 422)				int currentEnd1 = (currentEnd - (n -  ::Dynamic(r->__Field(HX_("right",dc,0b,64,e9),hx::paccDynamic))->__Field(HX_("end",db,03,4d,00),hx::paccDynamic)));
HXLINE( 424)				if ((currentEnd1 < (this->currentLoc +  ::Dynamic(r->__Field(HX_("right",dc,0b,64,e9),hx::paccDynamic))->__Field(HX_("end",db,03,4d,00),hx::paccDynamic)))) {
HXLINE( 425)					int len;
HXDLIN( 425)					if ((currentEnd1 < this->currentLoc)) {
HXLINE( 425)						len = 0;
            					}
            					else {
HXLINE( 425)						len = (currentEnd1 - this->currentLoc);
            					}
HXLINE( 431)					len = (len +  ::Dynamic(r->__Field(HX_("left",07,08,b0,47),hx::paccDynamic))->__Field(HX_("start",62,74,0b,84),hx::paccDynamic));
...
HXLINE( 445)			int _hx_tmp3 = this->knownLocForPacket;
HXDLIN( 445)			this->currentLoc = (_hx_tmp3 - (n2 -  ::Dynamic(r->__Field(HX_("left",07,08,b0,47),hx::paccDynamic))->__Field(HX_("start",62,74,0b,84),hx::paccDynamic)));
HXLINE( 446)			currentLocValid = true;
            		}
HXLINE( 449)		if (currentLocValid) {
HXLINE( 450)			 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 450)			_hx_tmp4->currentLoc = (_hx_tmp4->currentLoc + ( ::Dynamic(r->__Field(HX_("right",dc,0b,64,e9),hx::paccDynamic))->__Field(HX_("start",62,74,0b,84),hx::paccDynamic) -  ::Dynamic(r->__Field(HX_("left",07,08,b0,47),hx::paccDynamic))->__Field(HX_("start",62,74,0b,84),hx::paccDynamic)));
            		}
...
HXLINE( 478)				_g1 = (_g1 + 1);
HXDLIN( 478)				int i = (_g1 - 1);
HXLINE( 479)				{
...
HXLINE( 492)		return this->input->readString(n);
            	}
...
HXDLIN( 547)		{
HXLINE( 547)			int _g11 = 0;
HXDLIN( 547)			int _g2 = 6;
HXDLIN( 547)			while((_g11 < _g2)){
HXLINE( 547)				_g11 = (_g11 + 1);
HXDLIN( 547)				int i = (_g11 - 1);
HXDLIN( 547)				{
...
HXDLIN( 598)								header->__unsafe_set(i,val);
            							}
            						}
            					}
...
HXLINE( 607)					{
HXLINE( 607)						int _g1 = 22;
HXDLIN( 607)						while((_g1 < 26)){
HXLINE( 607)							_g1 = (_g1 + 1);
HXDLIN( 607)							int i1 = (_g1 - 1);
HXLINE( 608)							header->__unsafe_set(i1,0);
            						}
            					}
HXLINE( 611)					int crc = 0;
HXLINE( 612)					{
HXLINE( 612)						int _g2 = 0;
HXDLIN( 612)						while((_g2 < 27)){
HXLINE( 612)							_g2 = (_g2 + 1);
HXDLIN( 612)							int i2 = (_g2 - 1);
HXLINE( 613)							int byte = ( (int)(_hx_array_unsafe_get(header,i2)) );
...
HXLINE( 617)					try {
            						HX_STACK_CATCHABLE( ::haxe::io::Eof, 0);
HXLINE( 618)						{
HXLINE( 618)							int _g11 = 0;
HXDLIN( 618)							int _g3 = ( (int)(_hx_array_unsafe_get(header,26)) );
HXDLIN( 618)							while((_g11 < _g3)){
HXLINE( 618)								_g11 = (_g11 + 1);
HXDLIN( 618)								int i3 = (_g11 - 1);
HXLINE( 619)								 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp7 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 619)								_hx_tmp7->inputPosition = (_hx_tmp7->inputPosition + 1);
...
HXDLIN( 662)		{
HXLINE( 662)			int _g11 = 0;
HXDLIN( 662)			int _g2 = n;
HXDLIN( 662)			while((_g11 < _g2)){
HXLINE( 662)				_g11 = (_g11 + 1);
HXDLIN( 662)				int i1 = (_g11 - 1);
HXDLIN( 662)				{
...
HXLINE( 666)		{
HXLINE( 666)			int _g12 = 0;
HXDLIN( 666)			int _g3 = ( (int)(_hx_array_unsafe_get(pageHeader,26)) );
HXDLIN( 666)			while((_g12 < _g3)){
HXLINE( 666)				_g12 = (_g12 + 1);
HXDLIN( 666)				int i2 = (_g12 - 1);
...
HXLINE( 693)		{
HXLINE( 693)			int _g13 = 0;
HXDLIN( 693)			int _g4 = ( (int)(_hx_array_unsafe_get(pageHeader,26)) );
HXDLIN( 693)			while((_g13 < _g4)){
HXLINE( 693)				_g13 = (_g13 + 1);
HXDLIN( 693)				int i3 = (_g13 - 1);
...
HXDLIN( 708)					::Array< int > log2_4 = ::Array_obj< int >::fromData( _hx_array_data_19036b3c_55,16);
HXDLIN( 708)					int b3;
...
HXDLIN( 715)							{
HXLINE( 715)								int _g14 = 0;
HXDLIN( 715)								int _g5 = len1;
HXDLIN( 715)								while((_g14 < _g5)){
HXLINE( 715)									_g14 = (_g14 + 1);
HXDLIN( 715)									int i4 = (_g14 - 1);
HXDLIN( 715)									{
...
HXDLIN( 717)							int _g6 = len2;
HXDLIN( 717)							while((_g15 < _g6)){
HXLINE( 717)								_g15 = (_g15 + 1);
HXDLIN( 717)								int i5 = (_g15 - 1);
HXDLIN( 717)								{
...
HXLINE( 745)					int samples2 = ((h->blocksize1 - h->blocksize0) >> 2);
HXDLIN( 745)					samples = (samples + (samples2 + (h->blocksize0 >> 1)));
            				}
            			}
            			else {
...
HXLINE( 776)		z->firstDecodedSample = (z->lastDecodedSample - samples);
...
HXLINE( 831)		{
HXLINE( 831)			int _g1 = 0;
HXDLIN( 831)			int _g = c->entries;
HXDLIN( 831)			while((_g1 < _g)){
HXLINE( 831)				_g1 = (_g1 + 1);
HXDLIN( 831)				int i = (_g1 - 1);
