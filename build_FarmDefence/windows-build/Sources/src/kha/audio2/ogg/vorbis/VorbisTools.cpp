...
HXLINE( 177)				_g1 = (_g1 + 1);
HXDLIN( 177)				int i = (_g1 - 1);
HXLINE( 178)				{
HXLINE( 178)					int n1 = i;
...
HXDLIN( 188)				int k = (_g1 - 1);
HXLINE( 189)				af->__unsafe_set(k2,::Math_obj::cos((((4 * k) * ((Float)3.14159265358979323846264)) / ( (Float)(n) ))));
HXLINE( 190)				{
HXLINE( 190)					 ::Dynamic af1 = af->__Field(HX_("__unsafe_set",e9,ea,a4,60),hx::paccDynamic);
HXDLIN( 190)					af1((k2 + 1),-(::Math_obj::sin((((4 * k) * ((Float)3.14159265358979323846264)) / ( (Float)(n) )))));
            				}
HXLINE( 191)				bf->__unsafe_set(k2,(::Math_obj::cos(((((k2 + 1) * ((Float)3.14159265358979323846264)) / ( (Float)(n) )) / ( (Float)(2) ))) * ((Float)0.5)));
HXLINE( 192)				{
HXLINE( 192)					 ::Dynamic bf1 = bf->__Field(HX_("__unsafe_set",e9,ea,a4,60),hx::paccDynamic);
HXDLIN( 192)					bf1((k2 + 1),(::Math_obj::sin(((((k2 + 1) * ((Float)3.14159265358979323846264)) / ( (Float)(n) )) / ( (Float)(2) ))) * ((Float)0.5)));
            				}
HXLINE( 193)				k2 = (k2 + 2);
            			}
            		}
...
HXLINE( 197)		{
HXLINE( 197)			int _g11 = 0;
HXDLIN( 197)			int _g2 = n8;
HXDLIN( 197)			while((_g11 < _g2)){
HXLINE( 197)				_g11 = (_g11 + 1);
HXDLIN( 197)				int k1 = (_g11 - 1);
HXLINE( 198)				cf->__unsafe_set(k21,::Math_obj::cos((((2 * (k21 + 1)) * ((Float)3.14159265358979323846264)) / ( (Float)(n) ))));
HXLINE( 199)				{
HXLINE( 199)					 ::Dynamic cf1 = cf->__Field(HX_("__unsafe_set",e9,ea,a4,60),hx::paccDynamic);
HXDLIN( 199)					cf1((k21 + 1),-(::Math_obj::sin((((2 * (k21 + 1)) * ((Float)3.14159265358979323846264)) / ( (Float)(n) )))));
            				}
...
HXLINE( 247)		{
HXLINE( 247)			int _g12 = (x + 1);
HXDLIN( 247)			int _g3 = x1;
HXDLIN( 247)			while((_g12 < _g3)){
HXLINE( 247)				_g12 = (_g12 + 1);
HXDLIN( 247)				int i1 = (_g12 - 1);
...
HXLINE( 269)		Float err = ::Math_obj::abs(( (Float)(dy) ));
HXDLIN( 269)		Float err1 = (err * (x - x0));
HXLINE( 270)		int off = ::Std_obj::_hx_int((err1 / ( (Float)(adx) )));
HXLINE( 271)		if ((dy < 0)) {
...
HXLINE( 286)				_g1 = (_g1 + 1);
HXDLIN( 286)				int i = (_g1 - 1);
HXLINE( 287)				{
