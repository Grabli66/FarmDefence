...
static const int _hx_array_data_ee7b42a6_44[] = {
...
HXLINE( 216)		{
HXLINE( 216)			int _g = 0;
HXDLIN( 216)			while((_g < 32)){
HXLINE( 216)				_g = (_g + 1);
HXDLIN( 216)				int x = (_g - 1);
HXDLIN( 216)				available->__unsafe_set(x,0);
            			}
            		}
HXLINE( 219)		int k = 0;
...
HXDLIN( 259)				if ((z > 0)) {
HXLINE( 259)					_hx_tmp1 = (( (int)(_hx_array_unsafe_get(available,z)) ) == 0);
            				}
            				else {
...
HXDLIN( 293)						_hx_tmp1[_hx_tmp2] = (hx::UShr(n,16) | (n << 16));
            					}
            				}
            			}
            		}
            		else {
HXLINE( 298)			int _g11 = 0;
HXDLIN( 298)			int _g2 = this->sortedEntries;
HXDLIN( 298)			while((_g11 < _g2)){
HXLINE( 298)				_g11 = (_g11 + 1);
HXDLIN( 298)				int i1 = (_g11 - 1);
...
HXDLIN( 299)				_hx_tmp3[i1] = (hx::UShr(n1,16) | (n1 << 16));
            			}
            		}
...
HXLINE( 312)		{
HXLINE( 312)			int _g12 = 0;
HXDLIN( 312)			int _g3 = len1;
HXDLIN( 312)			while((_g12 < _g3)){
HXLINE( 312)				_g12 = (_g12 + 1);
HXDLIN( 312)				int i2 = (_g12 - 1);
...
HXDLIN( 344)			int _g = 1024;
HXDLIN( 344)			while((_g1 < _g)){
HXLINE( 344)				_g1 = (_g1 + 1);
HXDLIN( 344)				int i = (_g1 - 1);
...
HXLINE( 353)		{
HXLINE( 353)			int _g11 = 0;
HXDLIN( 353)			int _g2 = len;
HXDLIN( 353)			while((_g11 < _g2)){
HXLINE( 353)				_g11 = (_g11 + 1);
HXDLIN( 353)				int i1 = (_g11 - 1);
...
HXLINE( 400)			{
HXLINE( 400)				int _g11 = 0;
HXDLIN( 400)				int _g4 = len;
HXDLIN( 400)				while((_g11 < _g4)){
HXLINE( 400)					_g11 = (_g11 + 1);
HXDLIN( 400)					int i2 = (_g11 - 1);
...
HXLINE( 433)			{
HXLINE( 433)				int _g1 = 0;
HXDLIN( 433)				int _g = len;
HXDLIN( 433)				while((_g1 < _g)){
HXLINE( 433)					_g1 = (_g1 + 1);
HXDLIN( 433)					int i1 = (_g1 - 1);
...
HXLINE( 446)		{
HXLINE( 446)			int _g11 = 0;
HXDLIN( 446)			int _g4 = len;
HXDLIN( 446)			while((_g11 < _g4)){
HXLINE( 446)				_g11 = (_g11 + 1);
HXDLIN( 446)				int i2 = (_g11 - 1);
...
HXLINE( 529)						_g11 = (_g11 + 1);
HXDLIN( 529)						int i2 = (_g11 - 1);
...
HXLINE( 543)					int _g12 = 0;
HXDLIN( 543)					int _g5 = effective;
HXDLIN( 543)					while((_g12 < _g5)){
HXLINE( 543)						_g12 = (_g12 + 1);
HXDLIN( 543)						int i3 = (_g12 - 1);
...
HXLINE( 553)					int _g13 = 0;
HXDLIN( 553)					int _g6 = effective;
HXDLIN( 553)					while((_g13 < _g6)){
HXLINE( 553)						_g13 = (_g13 + 1);
HXDLIN( 553)						int i4 = (_g13 - 1);
...
HXLINE(  48)		int _hx_tmp2 = (decodeState->readBits(8) << 16);
HXDLIN(  48)		c->entries = ((_hx_tmp2 + (y << 8)) + x1);
...
HXLINE(  50)			_hx_tmp3 = (decodeState->readBits(1) != 0);
            		}
HXDLIN(  50)		c->sparse = _hx_tmp3;
...
HXLINE(  65)				::Array< int > log2_4 = ::Array_obj< int >::fromData( _hx_array_data_ee7b42a6_44,16);
HXDLIN(  65)				int n;
...
HXDLIN(  70)						lengths1((currentEntry + i),currentLength);
            					}
            				}
...
HXLINE(  76)			int _g11 = 0;
HXDLIN(  76)			int _g2 = c->entries;
HXDLIN(  76)			while((_g11 < _g2)){
HXLINE(  76)				_g11 = (_g11 + 1);
HXDLIN(  76)				int j = (_g11 - 1);
...
HXLINE(  87)			_hx_tmp4 = (total >= (c->entries >> 2));
            		}
            		else {
...
HXLINE(  92)			_hx_tmp5 = total;
            		}
            		else {
HXLINE(  95)			int sortedCount = 0;
HXLINE(  96)			{
HXLINE(  96)				int _g12 = 0;
HXDLIN(  96)				int _g3 = c->entries;
HXDLIN(  96)				while((_g12 < _g3)){
HXLINE(  96)					_g12 = (_g12 + 1);
HXDLIN(  96)					int j1 = (_g12 - 1);
HXLINE(  97)					int l = ( (int)(_hx_array_unsafe_get(lengths,j1)) );
HXLINE(  98)					bool _hx_tmp6;
HXDLIN(  98)					if ((l > 10)) {
HXLINE(  98)						_hx_tmp6 = (l != 255);
            					}
            					else {
...
HXLINE(  92)			_hx_tmp5 = sortedCount;
            		}
HXDLIN(  92)		c->sortedEntries = _hx_tmp5;
...
HXDLIN( 116)			int size = (c1 + (64 * c->sortedEntries));
            		}
...
HXLINE( 158)			{
HXLINE( 158)				int _g13 = 0;
HXDLIN( 158)				int _g4 = c->lookupValues;
HXDLIN( 158)				while((_g13 < _g4)){
HXLINE( 158)					_g13 = (_g13 + 1);
HXDLIN( 158)					int j2 = (_g13 - 1);
...
HXDLIN( 170)						int j3 = (_g14 - 1);
HXLINE( 171)						{
HXLINE( 171)							::Array< Float > this9 = c->multiplicands;
HXDLIN( 171)							Float val1 = (( (int)(_hx_array_unsafe_get(mults,j3)) ) * c->deltaValue);
...
HXLINE( 176)				_hx_tmp7 = c->sequenceP;
            			}
            			else {
...
HXLINE( 177)				{
HXLINE( 177)					int _g15 = 1;
HXDLIN( 177)					int _g6 = c->lookupValues;
HXDLIN( 177)					while((_g15 < _g6)){
HXLINE( 177)						_g15 = (_g15 + 1);
HXDLIN( 177)						int j4 = (_g15 - 1);
HXLINE( 178)						{
