...
HXDLIN(  61)						header->b[i] = ( (unsigned char)(x) );
            					}
            				}
            			}
...
HXDLIN(  64)		decodeState3->inputPosition = (decodeState3->inputPosition + 4);
...
HXDLIN(  71)		decodeState4->inputPosition = (decodeState4->inputPosition + 1);
...
HXDLIN(  78)		decodeState5->inputPosition = (decodeState5->inputPosition + 4);
...
HXDLIN(  83)		decodeState6->inputPosition = (decodeState6->inputPosition + 4);
...
HXDLIN(  84)		decodeState7->inputPosition = (decodeState7->inputPosition + 4);
...
HXDLIN(  85)		decodeState8->inputPosition = (decodeState8->inputPosition + 4);
...
HXDLIN(  87)		decodeState9->inputPosition = (decodeState9->inputPosition + 1);
HXDLIN(  87)		int x2 = decodeState->input->readByte();
HXLINE(  88)		int log0 = (x2 & 15);
HXLINE(  89)		int log1 = (x2 >> 4);
...
HXDLIN( 103)		decodeState10->inputPosition = (decodeState10->inputPosition + 1);
HXDLIN( 103)		int x3 = decodeState->input->readByte();
HXLINE( 104)		if (((x3 & 1) == 0)) {
...
HXLINE( 148)				x6 = (decodeState->next() == 0);
            			}
            			else {
HXLINE( 148)				x6 = true;
            			}
...
HXDLIN( 148)			decodeState12->inputPosition = (decodeState12->inputPosition + 1);
...
HXDLIN( 152)							decodeState13->inputPosition = (decodeState13->inputPosition + 1);
HXDLIN( 152)							x7 = decodeState->input->readByte();
            						}
HXDLIN( 152)						decodeState->validBits = 0;
HXDLIN( 152)						header3->b[i2] = ( (unsigned char)(x7) );
            					}
            				}
            			}
...
HXLINE( 157)		{
HXLINE( 157)			int _g11 = 0;
HXDLIN( 157)			int _g4 = codebookCount;
HXDLIN( 157)			while((_g11 < _g4)){
HXLINE( 157)				_g11 = (_g11 + 1);
HXDLIN( 157)				int i3 = (_g11 - 1);
HXLINE( 158)				{
...
HXLINE( 172)		{
HXLINE( 172)			int _g13 = 0;
HXDLIN( 172)			int _g6 = floorCount;
HXDLIN( 172)			while((_g13 < _g6)){
HXLINE( 172)				_g13 = (_g13 + 1);
HXDLIN( 172)				int i5 = (_g13 - 1);
HXLINE( 173)				{
...
HXLINE( 179)		{
HXLINE( 179)			int _g14 = 0;
HXDLIN( 179)			int _g7 = residueCount;
HXDLIN( 179)			while((_g14 < _g7)){
HXLINE( 179)				_g14 = (_g14 + 1);
HXDLIN( 179)				int i6 = (_g14 - 1);
HXLINE( 180)				{
...
HXLINE( 186)		{
HXLINE( 186)			int _g15 = 0;
HXDLIN( 186)			int _g8 = mappingCount;
HXDLIN( 186)			while((_g15 < _g8)){
HXLINE( 186)				_g15 = (_g15 + 1);
HXDLIN( 186)				int i7 = (_g15 - 1);
...
HXLINE( 189)				{
HXLINE( 189)					int _g31 = 0;
HXDLIN( 189)					int _g21 = map->submaps;
HXDLIN( 189)					while((_g31 < _g21)){
HXLINE( 189)						_g31 = (_g31 + 1);
HXDLIN( 189)						int j = (_g31 - 1);
...
HXLINE( 201)		{
HXLINE( 201)			int _g16 = 0;
HXDLIN( 201)			int _g9 = modeCount;
HXDLIN( 201)			while((_g16 < _g9)){
HXLINE( 201)				_g16 = (_g16 + 1);
HXDLIN( 201)				int i8 = (_g16 - 1);
...
HXLINE( 209)				goto _hx_goto_12;
            			}
HXDLIN( 209)			decodeState->bytesInSeg--;
HXDLIN( 209)			{
HXLINE( 209)				 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState14 = decodeState;
HXDLIN( 209)				decodeState14->inputPosition = (decodeState14->inputPosition + 1);
