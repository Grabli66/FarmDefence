...
HXLINE( 111)					_g11 = (_g11 + 1);
HXDLIN( 111)					int j1 = (_g11 - 1);
HXLINE( 112)					{
...
HXLINE(  42)			{
HXLINE(  42)				int _g11 = 0;
HXDLIN(  42)				int _g2 = m->couplingSteps;
HXDLIN(  42)				while((_g11 < _g2)){
HXLINE(  42)					_g11 = (_g11 + 1);
HXDLIN(  42)					int k = (_g11 - 1);
...
HXLINE(  71)			int _g13 = 0;
HXDLIN(  71)			int _g4 = channels;
HXDLIN(  71)			while((_g13 < _g4)){
HXLINE(  71)				_g13 = (_g13 + 1);
HXDLIN(  71)				int j2 = (_g13 - 1);
...
HXLINE(  79)		{
HXLINE(  79)			int _g14 = 0;
HXDLIN(  79)			int _g5 = m->submaps;
HXDLIN(  79)			while((_g14 < _g5)){
HXLINE(  79)				_g14 = (_g14 + 1);
HXDLIN(  79)				int j3 = (_g14 - 1);
