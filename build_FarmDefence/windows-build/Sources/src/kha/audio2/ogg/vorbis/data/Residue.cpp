...
HXLINE( 104)			{
HXLINE( 104)				int _g11 = 0;
HXDLIN( 104)				int _g4 = ch;
HXDLIN( 104)				while((_g11 < _g4)){
HXLINE( 104)					_g11 = (_g11 + 1);
HXDLIN( 104)					int j1 = (_g11 - 1);
...
HXLINE( 113)			{
HXLINE( 113)				int _g5 = 0;
HXDLIN( 113)				while((_g5 < 8)){
HXLINE( 113)					_g5 = (_g5 + 1);
HXDLIN( 113)					int pass = (_g5 - 1);
...
HXLINE( 134)							{
HXLINE( 134)								int _g21 = 0;
HXDLIN( 134)								int _g12 = classwords;
HXDLIN( 134)								while((_g21 < _g12)){
HXLINE( 134)									_g21 = (_g21 + 1);
HXDLIN( 134)									int i3 = (_g21 - 1);
...
HXLINE( 178)								{
HXLINE( 178)									int _g22 = 0;
HXDLIN( 178)									int _g13 = classwords;
HXDLIN( 178)									while((_g22 < _g13)){
HXLINE( 178)										_g22 = (_g22 + 1);
HXDLIN( 178)										int i6 = (_g22 - 1);
...
HXLINE( 223)								{
HXLINE( 223)									int _g23 = 0;
HXDLIN( 223)									int _g14 = classwords;
HXDLIN( 223)									while((_g23 < _g14)){
HXLINE( 223)										_g23 = (_g23 + 1);
HXDLIN( 223)										int i9 = (_g23 - 1);
...
HXLINE( 254)		{
HXLINE( 254)			int _g6 = 0;
HXDLIN( 254)			while((_g6 < 8)){
HXLINE( 254)				_g6 = (_g6 + 1);
HXDLIN( 254)				int pass1 = (_g6 - 1);
HXLINE( 255)				int pcount1 = 0;
HXLINE( 256)				int classSet1 = 0;
HXLINE( 257)				while((pcount1 < partRead2)){
HXLINE( 258)					if ((pass1 == 0)) {
HXLINE( 259)						int _g24 = 0;
HXDLIN( 259)						int _g15 = ch;
HXDLIN( 259)						while((_g24 < _g15)){
HXLINE( 259)							_g24 = (_g24 + 1);
HXDLIN( 259)							int j2 = (_g24 - 1);
...
HXLINE(  52)						int _hx_tmp = ( (int)(_hx_array_unsafe_get(residueCascade,j1)) );
HXDLIN(  52)						if (((_hx_tmp & (1 << k)) != 0)) {
HXLINE(  53)							{
...
HXLINE(  54)							int _hx_tmp1 = ( (int)(_hx_array_unsafe_get(( (::Array< int >)(_hx_array_unsafe_get(r->residueBooks,j1)) ),k)) );
HXDLIN(  54)							if ((_hx_tmp1 >= codebooks->length)) {
...
HXDLIN(  74)					cd1(k1,hx::Mod(temp,classifications));
