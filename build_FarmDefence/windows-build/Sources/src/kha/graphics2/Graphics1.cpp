...
HXDLIN(  37)		int pos = ((y * this->texture->get_realWidth()) * 4);
HXDLIN(  37)		int pos1 = (pos + (x * 4));
HXDLIN(  37)		_this->b[pos1] = ( (unsigned char)(color) );
HXDLIN(  37)		::Array< unsigned char > _this1 = _this->b;
HXDLIN(  37)		_this1[(pos1 + 1)] = ( (unsigned char)((color >> 8)) );
HXDLIN(  37)		::Array< unsigned char > _this2 = _this->b;
HXDLIN(  37)		_this2[(pos1 + 2)] = ( (unsigned char)((color >> 16)) );
HXDLIN(  37)		::Array< unsigned char > _this3 = _this->b;
HXDLIN(  37)		_this3[(pos1 + 3)] = ( (unsigned char)(hx::UShr(color,24)) );
            	}
...
static hx::StorageInfo Graphics1_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::kha::Canvas*/ ,(int)offsetof(Graphics1_obj,canvas),HX_("canvas",d8,54,42,b8)},
