...
HXDLIN( 371)					int _g2 = (ch22 | (ch12 << 8));
...
HXDLIN( 373)							int _g21 = (ch24 | (ch14 << 8));
...
HXDLIN( 502)			int pos = (info2 + (glyph_index * 2));
...
HXDLIN( 506)			g2 = (info7 + (((ch41 | (ch31 << 8)) | (ch23 << 16)) | (ch13 << 24)));
            		}
HXLINE( 509)		if ((g1 == g2)) {
HXLINE( 509)			return -1;
            		}
...
HXDLIN( 539)				 ::kha::graphics2::truetype::Stbtt_vertex _hx_tmp = ( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,(num_vertices - 1))) );
HXDLIN( 539)				::kha::graphics2::truetype::StbTruetype_obj::stbtt_setvertex(_hx_tmp,3,((cx + scx) >> 1),((cy + scy) >> 1),cx,cy);
            			}
...
HXDLIN( 576)			endPtsOfContours = data->sub((g + 10),(endPtsOfContours1 - (g + 10)));
...
HXLINE( 578)			int points = data->get_length();
HXLINE( 574)			 ::kha::internal::BytesBlob points1 = data->sub(((((g + 10) + (numberOfContours * 2)) + 2) + ins),(points - ((((g + 10) + (numberOfContours * 2)) + 2) + ins)));
...
HXLINE( 573)			int x = 0;
HXLINE( 615)			{
HXLINE( 615)				int _g12 = 0;
HXDLIN( 615)				int _g3 = n1;
HXDLIN( 615)				while((_g12 < _g3)){
HXLINE( 615)					_g12 = (_g12 + 1);
HXDLIN( 615)					int i2 = (_g12 - 1);
...
HXDLIN( 618)						int dx = points1->readU8((pointsIndex - 1));
HXLINE( 619)						int x1;
...
HXLINE( 623)							int ch13 = points1->readU8(pointsIndex);
HXLINE( 624)							int ch23 = points1->readU8((pointsIndex + 1));
...
HXLINE( 573)			int y = 0;
HXLINE( 639)			{
HXLINE( 639)				int _g13 = 0;
HXDLIN( 639)				int _g4 = n1;
HXDLIN( 639)				while((_g13 < _g4)){
HXLINE( 639)					_g13 = (_g13 + 1);
HXDLIN( 639)					int i3 = (_g13 - 1);
...
HXDLIN( 642)						int dy = points1->readU8((pointsIndex - 1));
HXLINE( 643)						int y1;
...
HXLINE( 647)							int ch14 = points1->readU8(pointsIndex);
HXLINE( 648)							int ch24 = points1->readU8((pointsIndex + 1));
...
HXDLIN( 702)							 ::kha::graphics2::truetype::Stbtt_vertex _hx_tmp = ( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,(num_vertices - 1))) );
HXDLIN( 702)							::kha::graphics2::truetype::StbTruetype_obj::stbtt_setvertex(_hx_tmp,3,((cx + x) >> 1),((cy + y) >> 1),cx,cy);
            						}
HXLINE( 703)						cx = x;
HXLINE( 704)						cy = y;
...
HXDLIN( 720)				 ::kha::internal::BytesBlob comp1 = data->sub((g + 10),(comp - (g + 10)));
...
HXDLIN( 737)					int ch26 = comp1->readU8((compIndex + 1));
...
HXDLIN( 738)					int ch27 = comp1->readU8((compIndex + 1));
...
HXDLIN( 742)							int ch28 = comp1->readU8((compIndex + 1));
...
HXDLIN( 743)							int ch29 = comp1->readU8((compIndex + 1));
...
HXLINE( 745)							int n8 = comp1->readU8(compIndex);
...
HXLINE( 746)							int n9 = comp1->readU8(compIndex);
...
HXDLIN( 754)						int ch210 = comp1->readU8((compIndex + 1));
...
HXDLIN( 757)							int ch211 = comp1->readU8((compIndex + 1));
...
HXDLIN( 759)							int ch212 = comp1->readU8((compIndex + 1));
...
HXDLIN( 761)								int ch213 = comp1->readU8((compIndex + 1));
...
HXDLIN( 762)								int ch214 = comp1->readU8((compIndex + 1));
...
HXDLIN( 763)								int ch215 = comp1->readU8((compIndex + 1));
...
HXDLIN( 764)								int ch216 = comp1->readU8((compIndex + 1));
...
HXLINE( 776)								_g14 = (_g14 + 1);
HXDLIN( 776)								int i6 = (_g14 - 1);
...
HXLINE( 781)								v->y = ::Std_obj::_hx_int((n17 * (((mtx1 * x2) + (mtx3 * y2)) + mtx5)));
HXLINE( 782)								x2 = v->cx;
HXDLIN( 782)								y2 = v->cy;
HXLINE( 783)								v->cx = ::Std_obj::_hx_int((m1 * (((mtx0 * x2) + (mtx2 * y2)) + mtx4)));
HXLINE( 784)								v->cy = ::Std_obj::_hx_int((n17 * (((mtx1 * x2) + (mtx3 * y2)) + mtx5)));
            							}
            						}
...
HXDLIN( 822)			int pos1 = (info1 + (4 * glyph_index));
...
HXDLIN( 823)			int pos2 = ((info2 + (4 * glyph_index)) + 2);
...
HXDLIN( 825)			int pos3 = (info3 + (4 * (numOfLongHorMetrics - 1)));
...
HXDLIN( 826)			int pos4 = (info4 + (4 * numOfLongHorMetrics));
HXDLIN( 826)			int pos5 = (pos4 + (2 * (glyph_index - numOfLongHorMetrics)));
HXDLIN( 826)			int ch14 = p4->readU8(pos5);
HXDLIN( 826)			int ch24 = p4->readU8((pos5 + 1));
...
HXDLIN( 990)						_g11->__unsafe_set(_g2,(val1 + (val2 * (1 - (((x0 - x) + (x1 - x)) / ( (Float)(2) ))))));
            					}
            				}
            			}
            		}
...
HXDLIN(1049)								_g1->__unsafe_set(_g,(val + ((e1 * (1 - (((x_top - x) + (x_bottom - x)) / ( (Float)(2) )))) * height)));
            							}
            						}
HXLINE(1050)						{
...
HXLINE(1053)						Float y_crossing = ((((x11 + 1) - x01) * dy) + y_top);
...
HXDLIN(1076)								_g12->__unsafe_set(_g3,(val2 + (area * (1 - (((x_top - x11) + ((x11 + 1) - x11)) / ( (Float)(2) ))))));
            							}
            						}
HXLINE(1053)						Float step = (sign * dy);
HXLINE(1079)						{
HXLINE(1079)							int _g13 = (x11 + 1);
HXDLIN(1079)							int _g4 = x2;
HXDLIN(1079)							while((_g13 < _g4)){
HXLINE(1079)								_g13 = (_g13 + 1);
HXDLIN(1079)								int x3 = (_g13 - 1);
HXLINE(1080)								{
HXLINE(1080)									int _g21 = x3;
HXDLIN(1080)									::Array< Float > _g31 = scanline;
HXDLIN(1080)									{
HXLINE(1080)										Float val3 = ( (Float)(_hx_array_unsafe_get(_g31,_g21)) );
HXDLIN(1080)										_g31->__unsafe_set(_g21,(val3 + (area + (step / ( (Float)(2) )))));
            									}
            								}
HXLINE(1081)								area = (area + step);
            							}
            						}
HXLINE(1083)						y_crossing = (y_crossing + (dy * (x2 - (x11 + 1))));
...
HXDLIN(1087)								_g14->__unsafe_set(_g5,(val4 + (area + ((sign * (1 - (((x2 - x2) + (x_bottom - x2)) / ( (Float)(2) )))) * (sy1 - y_crossing)))));
            							}
            						}
HXLINE(1089)						{
...
HXLINE(1096)					int _g16 = 0;
HXDLIN(1096)					int _g7 = len;
HXDLIN(1096)					while((_g16 < _g7)){
HXLINE(1096)						_g16 = (_g16 + 1);
HXDLIN(1096)						int x4 = (_g16 - 1);
...
HXLINE(1116)						Float y1 = (((x4 - x01) / dx) + y_top);
HXDLIN(1116)						Float y2 = ((((x4 + 1) - x01) / dx) + y_top);
...
HXLINE(1179)			{
HXLINE(1179)				int _g1 = 0;
HXDLIN(1179)				int _g = result->w;
HXDLIN(1179)				while((_g1 < _g)){
HXLINE(1179)					_g1 = (_g1 + 1);
HXDLIN(1179)					int i = (_g1 - 1);
HXDLIN(1179)					scanline->__unsafe_set(i,0);
            				}
            			}
HXLINE(1180)			{
HXLINE(1180)				int _g11 = 0;
HXDLIN(1180)				int _g2 = (result->w + 1);
HXDLIN(1180)				while((_g11 < _g2)){
HXLINE(1180)					_g11 = (_g11 + 1);
HXDLIN(1180)					int i1 = (_g11 - 1);
HXDLIN(1180)					 ::Dynamic scanline21 = scanline2->__Field(HX_("__unsafe_set",e9,ea,a4,60),hx::paccDynamic);
HXDLIN(1180)					scanline21((scanline2Index + i1),0);
            				}
            			}
...
HXLINE(1224)				{
HXLINE(1224)					int _g12 = 0;
HXDLIN(1224)					int _g3 = result->w;
HXDLIN(1224)					while((_g12 < _g3)){
HXLINE(1224)						_g12 = (_g12 + 1);
HXDLIN(1224)						int i2 = (_g12 - 1);
...
HXDLIN(1232)						result1->writeU8(((result2 + (j * result->stride)) + i2),m);
            					}
            				}
            			}
...
HXDLIN(1254)		int j;
HXLINE(1255)		{
HXLINE(1255)			int _g1 = 1;
HXDLIN(1255)			int _g = n;
HXDLIN(1255)			while((_g1 < _g)){
HXLINE(1255)				_g1 = (_g1 + 1);
HXDLIN(1255)				int i1 = (_g1 - 1);
...
HXLINE(1343)		int n = 0;
HXLINE(1351)		{
HXLINE(1351)			int _g1 = 0;
HXDLIN(1351)			int _g = windings;
HXDLIN(1351)			while((_g1 < _g)){
HXLINE(1351)				_g1 = (_g1 + 1);
HXDLIN(1351)				int i1 = (_g1 - 1);
...
HXLINE(1357)			int _g11 = 0;
HXDLIN(1357)			int _g2 = e->length;
HXDLIN(1357)			while((_g11 < _g2)){
HXLINE(1357)				_g11 = (_g11 + 1);
HXDLIN(1357)				int i2 = (_g11 - 1);
HXLINE(1358)				{
...
HXLINE(1343)		int m = 0;
HXLINE(1364)		{
HXLINE(1364)			int _g12 = 0;
HXDLIN(1364)			int _g3 = windings;
HXDLIN(1364)			while((_g12 < _g3)){
HXLINE(1364)				_g12 = (_g12 + 1);
HXDLIN(1364)				int i3 = (_g12 - 1);
...
HXLINE(1408)		Float mx = (((x0 + (2 * x1)) + x2) / ( (Float)(4) ));
HXLINE(1409)		Float my = (((y0 + (2 * y1)) + y2) / ( (Float)(4) ));
...
HXLINE(1608)		{
HXLINE(1608)			int _g1 = 0;
HXDLIN(1608)			int _g = (pw * ph);
HXDLIN(1608)			while((_g1 < _g)){
HXLINE(1608)				_g1 = (_g1 + 1);
HXDLIN(1608)				int i = (_g1 - 1);
...
HXLINE(1656)		int round_x = ::Math_obj::floor(((xpos->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic) + b->xoff) + ((Float)0.5)));
HXLINE(1657)		int round_y = ::Math_obj::floor(((ypos->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic) + b->yoff) + ((Float)0.5)));
