...
HXDLIN( 342)					triIndices1.set((i1 * 3),(i1 * 3));
HXLINE( 343)					 uint32array triIndices2 = triIndices->self;
HXDLIN( 343)					triIndices2.set(((i1 * 3) + 1),((i1 * 3) + 1));
HXLINE( 344)					 uint32array triIndices3 = triIndices->self;
HXDLIN( 344)					triIndices3.set(((i1 * 3) + 2),((i1 * 3) + 2));
            				}
            			}
...
HXDLIN( 446)		::kha::graphics4::Graphics_obj::drawIndexedVertices(_hx_tmp2,0,((::kha::graphics4::ColoredShaderPainter_obj::bufferIndex * 2) * 3));
...
HXDLIN( 467)		::kha::graphics4::Graphics_obj::drawIndexedVertices(_hx_tmp2,0,(::kha::graphics4::ColoredShaderPainter_obj::triangleBufferIndex * 3));
...
static hx::StorageInfo ColoredShaderPainter_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::kha::graphics4::Graphics*/ ,(int)offsetof(ColoredShaderPainter_obj,g),HX_("g",67,00,00,00)},
	{hx::fsObject /*::kha::graphics4::PipelineState*/ ,(int)offsetof(ColoredShaderPainter_obj,myPipeline),HX_("myPipeline",ae,22,05,b9)},
	{hx::fsObject /*::kha::graphics4::ConstantLocation*/ ,(int)offsetof(ColoredShaderPainter_obj,projectionLocation),HX_("projectionLocation",e4,59,25,9b)},
