...
HXDLIN( 188)		::kha::graphics4::Graphics_obj::drawIndexedVertices(_hx_tmp5,0,((::kha::graphics4::ImageShaderPainter_obj::bufferIndex * 2) * 3));
...
HXLINE( 214)		{
HXLINE( 214)			float r = (hx::UShr((color & 16711680),16) * ( (float)(((Float)0.00392156862745098)) ));
HXDLIN( 214)			float g = (hx::UShr((color & 65280),8) * ( (float)(((Float)0.00392156862745098)) ));
HXDLIN( 214)			float b = ((color & 255) * ( (float)(((Float)0.00392156862745098)) ));
HXDLIN( 214)			float a = ((hx::UShr(color,24) * ( (float)(((Float)0.00392156862745098)) )) * opacity);
...
HXDLIN( 231)				this1.set((baseIndex + 3),left);
            			}
HXDLIN( 231)			{
HXLINE( 231)				 float32array this2 = ::kha::graphics4::ImageShaderPainter_obj::rectVertices->self;
HXDLIN( 231)				this2.set((baseIndex + 4),bottom);
            			}
HXDLIN( 231)			{
HXLINE( 231)				 float32array this3 = ::kha::graphics4::ImageShaderPainter_obj::rectVertices->self;
HXDLIN( 231)				this3.set((baseIndex + 12),left);
            			}
HXDLIN( 231)			{
HXLINE( 231)				 float32array this4 = ::kha::graphics4::ImageShaderPainter_obj::rectVertices->self;
HXDLIN( 231)				this4.set((baseIndex + 13),top);
            			}
HXDLIN( 231)			{
HXLINE( 231)				 float32array this5 = ::kha::graphics4::ImageShaderPainter_obj::rectVertices->self;
HXDLIN( 231)				this5.set((baseIndex + 21),right);
            			}
HXDLIN( 231)			{
HXLINE( 231)				 float32array this6 = ::kha::graphics4::ImageShaderPainter_obj::rectVertices->self;
HXDLIN( 231)				this6.set((baseIndex + 22),top);
            			}
HXDLIN( 231)			{
HXLINE( 231)				 float32array this7 = ::kha::graphics4::ImageShaderPainter_obj::rectVertices->self;
HXDLIN( 231)				this7.set((baseIndex + 30),right);
            			}
HXDLIN( 231)			{
HXLINE( 231)				 float32array this8 = ::kha::graphics4::ImageShaderPainter_obj::rectVertices->self;
HXDLIN( 231)				this8.set((baseIndex + 31),bottom);
            			}
            		}
HXLINE( 232)		{
HXLINE( 232)			float r = (hx::UShr((color & 16711680),16) * ( (float)(((Float)0.00392156862745098)) ));
HXDLIN( 232)			float g = (hx::UShr((color & 65280),8) * ( (float)(((Float)0.00392156862745098)) ));
HXDLIN( 232)			float b = ((color & 255) * ( (float)(((Float)0.00392156862745098)) ));
HXDLIN( 232)			float a = ((hx::UShr(color,24) * ( (float)(((Float)0.00392156862745098)) )) * opacity);
...
static hx::StorageInfo ImageShaderPainter_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::kha::graphics4::Graphics*/ ,(int)offsetof(ImageShaderPainter_obj,g),HX_("g",67,00,00,00)},
	{hx::fsObject /*::kha::graphics4::PipelineState*/ ,(int)offsetof(ImageShaderPainter_obj,myPipeline),HX_("myPipeline",ae,22,05,b9)},
	{hx::fsObject /*::kha::graphics4::ConstantLocation*/ ,(int)offsetof(ImageShaderPainter_obj,projectionLocation),HX_("projectionLocation",e4,59,25,9b)},
	{hx::fsObject /*::kha::graphics4::TextureUnit*/ ,(int)offsetof(ImageShaderPainter_obj,textureLocation),HX_("textureLocation",30,c6,65,4c)},
