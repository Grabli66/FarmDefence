...
::String id = __o_id.Default(HX_("unknown",8a,23,7b,e1));
...
static hx::StorageInfo Gamepad_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Gamepad_obj,axisListeners),HX_("axisListeners",9e,0c,ba,11)},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Gamepad_obj,buttonListeners),HX_("buttonListeners",2d,15,52,7d)},
...
static hx::StaticInfo Gamepad_obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*cpp::ArrayBase*/ ,(void *) &Gamepad_obj::connectListeners,HX_("connectListeners",35,3c,93,bd)},
	{hx::fsObject /*cpp::ArrayBase*/ ,(void *) &Gamepad_obj::disconnectListeners,HX_("disconnectListeners",83,75,33,15)},
	{ hx::fsUnknown, 0, null()}
};
#endif
