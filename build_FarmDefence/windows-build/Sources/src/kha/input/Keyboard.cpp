...
static hx::StorageInfo Keyboard_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Keyboard_obj,downListeners),HX_("downListeners",bd,30,f6,dd)},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Keyboard_obj,upListeners),HX_("upListeners",a4,bb,9c,9b)},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Keyboard_obj,pressListeners),HX_("pressListeners",7c,e9,d1,06)},
	{ hx::fsUnknown, 0, null()}
};
