...
HXDLIN( 110)					_hx_tmp(((HX_("no downListeners for window \"",ab,54,8f,21) + windowId) + HX_("\" are registered",0c,2e,32,e8)),hx::SourceInfo(HX_("kha/input/Mouse.hx",89,50,3f,8b),110,HX_("kha.input.Mouse",57,6b,87,5e),HX_("removeWindowed",b3,04,24,48)));
            				}
            			}
            			else {
...
HXDLIN( 124)					_hx_tmp1(((HX_("no upListeners for window \"",a4,97,3e,e5) + windowId) + HX_("\" are registered",0c,2e,32,e8)),hx::SourceInfo(HX_("kha/input/Mouse.hx",89,50,3f,8b),124,HX_("kha.input.Mouse",57,6b,87,5e),HX_("removeWindowed",b3,04,24,48)));
            				}
            			}
            			else {
...
HXDLIN( 138)					_hx_tmp2(((HX_("no moveListeners for window \"",9a,fa,38,bb) + windowId) + HX_("\" are registered",0c,2e,32,e8)),hx::SourceInfo(HX_("kha/input/Mouse.hx",89,50,3f,8b),138,HX_("kha.input.Mouse",57,6b,87,5e),HX_("removeWindowed",b3,04,24,48)));
            				}
            			}
            			else {
...
HXDLIN( 152)					_hx_tmp3(((HX_("no wheelListeners for window \"",c6,3b,5b,bf) + windowId) + HX_("\" are registered",0c,2e,32,e8)),hx::SourceInfo(HX_("kha/input/Mouse.hx",89,50,3f,8b),152,HX_("kha.input.Mouse",57,6b,87,5e),HX_("removeWindowed",b3,04,24,48)));
            				}
            			}
            			else {
...
HXDLIN( 166)					_hx_tmp4(((HX_("no leaveListeners for window \"",22,61,f4,74) + windowId) + HX_("\" are registered",0c,2e,32,e8)),hx::SourceInfo(HX_("kha/input/Mouse.hx",89,50,3f,8b),166,HX_("kha.input.Mouse",57,6b,87,5e),HX_("removeWindowed",b3,04,24,48)));
            				}
            			}
            			else {
...
HXDLIN(  61)				bytes1[5] = ( (unsigned char)((windowId >> 8)) );
HXDLIN(  61)				::Array< unsigned char > bytes2 = bytes->b;
HXDLIN(  61)				bytes2[6] = ( (unsigned char)((windowId >> 16)) );
HXDLIN(  61)				::Array< unsigned char > bytes3 = bytes->b;
HXDLIN(  61)				bytes3[7] = ( (unsigned char)(hx::UShr(windowId,24)) );
            			}
...
HXDLIN(  61)				::Array< unsigned char > bytes4 = bytes->b;
HXDLIN(  61)				bytes4[9] = ( (unsigned char)((x >> 8)) );
HXDLIN(  61)				::Array< unsigned char > bytes5 = bytes->b;
HXDLIN(  61)				bytes5[10] = ( (unsigned char)((x >> 16)) );
HXDLIN(  61)				::Array< unsigned char > bytes6 = bytes->b;
HXDLIN(  61)				bytes6[11] = ( (unsigned char)(hx::UShr(x,24)) );
            			}
HXDLIN(  61)			{
HXLINE(  61)				bytes->b[12] = ( (unsigned char)(y) );
HXDLIN(  61)				::Array< unsigned char > bytes7 = bytes->b;
HXDLIN(  61)				bytes7[13] = ( (unsigned char)((y >> 8)) );
HXDLIN(  61)				::Array< unsigned char > bytes8 = bytes->b;
HXDLIN(  61)				bytes8[14] = ( (unsigned char)((y >> 16)) );
HXDLIN(  61)				::Array< unsigned char > bytes9 = bytes->b;
HXDLIN(  61)				bytes9[15] = ( (unsigned char)(hx::UShr(y,24)) );
            			}
HXDLIN(  61)			{
HXLINE(  61)				bytes->b[16] = ( (unsigned char)(movementX) );
HXDLIN(  61)				::Array< unsigned char > bytes10 = bytes->b;
HXDLIN(  61)				bytes10[17] = ( (unsigned char)((movementX >> 8)) );
HXDLIN(  61)				::Array< unsigned char > bytes11 = bytes->b;
HXDLIN(  61)				bytes11[18] = ( (unsigned char)((movementX >> 16)) );
HXDLIN(  61)				::Array< unsigned char > bytes12 = bytes->b;
HXDLIN(  61)				bytes12[19] = ( (unsigned char)(hx::UShr(movementX,24)) );
            			}
HXDLIN(  61)			{
HXLINE(  61)				bytes->b[20] = ( (unsigned char)(movementY) );
HXDLIN(  61)				::Array< unsigned char > bytes13 = bytes->b;
HXDLIN(  61)				bytes13[21] = ( (unsigned char)((movementY >> 8)) );
HXDLIN(  61)				::Array< unsigned char > bytes14 = bytes->b;
HXDLIN(  61)				bytes14[22] = ( (unsigned char)((movementY >> 16)) );
HXDLIN(  61)				::Array< unsigned char > bytes15 = bytes->b;
HXDLIN(  61)				bytes15[23] = ( (unsigned char)(hx::UShr(movementY,24)) );
            			}
HXLINE( 100)			 ::kha::network::Session _hx_tmp = ::kha::network::Session_obj::the();
HXDLIN( 100)			_hx_tmp->sendControllerUpdate(this->_id(),bytes);
            		}
...
HXDLIN(  61)				::Array< unsigned char > bytes4 = bytes->b;
HXDLIN(  61)				bytes4[9] = ( (unsigned char)((delta >> 8)) );
HXDLIN(  61)				::Array< unsigned char > bytes5 = bytes->b;
HXDLIN(  61)				bytes5[10] = ( (unsigned char)((delta >> 16)) );
HXDLIN(  61)				::Array< unsigned char > bytes6 = bytes->b;
HXDLIN(  61)				bytes6[11] = ( (unsigned char)(hx::UShr(delta,24)) );
            			}
HXLINE( 100)			 ::kha::network::Session _hx_tmp = ::kha::network::Session_obj::the();
HXDLIN( 100)			_hx_tmp->sendControllerUpdate(this->_id(),bytes);
            		}
...
HXLINE( 117)		int bytes1 = ( (int)(bytes->b->__get(0)) );
HXDLIN( 117)		int funcindex = (bytes1 | (( (int)(bytes->b->__get(1)) ) << 8));
HXDLIN( 117)		int funcindex1 = (funcindex | (( (int)(bytes->b->__get(2)) ) << 16));
HXDLIN( 117)		int funcindex2 = (funcindex1 | (( (int)(bytes->b->__get(3)) ) << 24));
HXLINE( 190)		if ((funcindex2 == 0)) {
HXLINE( 145)			int bytes2 = ( (int)(bytes->b->__get(4)) );
HXDLIN( 145)			int input0 = (bytes2 | (( (int)(bytes->b->__get(5)) ) << 8));
HXDLIN( 145)			int input01 = (input0 | (( (int)(bytes->b->__get(6)) ) << 16));
HXDLIN( 145)			int input02 = (input01 | (( (int)(bytes->b->__get(7)) ) << 24));
HXLINE( 192)			this->sendLeaveEvent(input02);
HXLINE( 193)			return;
            		}
HXLINE( 220)		if ((funcindex2 == 1)) {
HXLINE( 145)			int bytes3 = ( (int)(bytes->b->__get(4)) );
HXDLIN( 145)			int input03 = (bytes3 | (( (int)(bytes->b->__get(5)) ) << 8));
HXDLIN( 145)			int input04 = (input03 | (( (int)(bytes->b->__get(6)) ) << 16));
HXDLIN( 145)			int input05 = (input04 | (( (int)(bytes->b->__get(7)) ) << 24));
HXDLIN( 145)			int bytes4 = ( (int)(bytes->b->__get(8)) );
HXDLIN( 145)			int input1 = (bytes4 | (( (int)(bytes->b->__get(9)) ) << 8));
HXDLIN( 145)			int input11 = (input1 | (( (int)(bytes->b->__get(10)) ) << 16));
HXDLIN( 145)			int input12 = (input11 | (( (int)(bytes->b->__get(11)) ) << 24));
HXDLIN( 145)			int bytes5 = ( (int)(bytes->b->__get(12)) );
HXDLIN( 145)			int input2 = (bytes5 | (( (int)(bytes->b->__get(13)) ) << 8));
HXDLIN( 145)			int input21 = (input2 | (( (int)(bytes->b->__get(14)) ) << 16));
HXDLIN( 145)			int input22 = (input21 | (( (int)(bytes->b->__get(15)) ) << 24));
HXDLIN( 145)			int bytes6 = ( (int)(bytes->b->__get(16)) );
HXDLIN( 145)			int input3 = (bytes6 | (( (int)(bytes->b->__get(17)) ) << 8));
HXDLIN( 145)			int input31 = (input3 | (( (int)(bytes->b->__get(18)) ) << 16));
HXDLIN( 145)			int input32 = (input31 | (( (int)(bytes->b->__get(19)) ) << 24));
HXLINE( 222)			this->sendDownEvent(input05,input12,input22,input32);
HXLINE( 223)			return;
            		}
HXLINE( 220)		if ((funcindex2 == 2)) {
HXLINE( 145)			int bytes7 = ( (int)(bytes->b->__get(4)) );
HXDLIN( 145)			int input06 = (bytes7 | (( (int)(bytes->b->__get(5)) ) << 8));
HXDLIN( 145)			int input07 = (input06 | (( (int)(bytes->b->__get(6)) ) << 16));
HXDLIN( 145)			int input08 = (input07 | (( (int)(bytes->b->__get(7)) ) << 24));
HXDLIN( 145)			int bytes8 = ( (int)(bytes->b->__get(8)) );
HXDLIN( 145)			int input13 = (bytes8 | (( (int)(bytes->b->__get(9)) ) << 8));
HXDLIN( 145)			int input14 = (input13 | (( (int)(bytes->b->__get(10)) ) << 16));
HXDLIN( 145)			int input15 = (input14 | (( (int)(bytes->b->__get(11)) ) << 24));
HXDLIN( 145)			int bytes9 = ( (int)(bytes->b->__get(12)) );
HXDLIN( 145)			int input23 = (bytes9 | (( (int)(bytes->b->__get(13)) ) << 8));
HXDLIN( 145)			int input24 = (input23 | (( (int)(bytes->b->__get(14)) ) << 16));
HXDLIN( 145)			int input25 = (input24 | (( (int)(bytes->b->__get(15)) ) << 24));
HXDLIN( 145)			int bytes10 = ( (int)(bytes->b->__get(16)) );
HXDLIN( 145)			int input33 = (bytes10 | (( (int)(bytes->b->__get(17)) ) << 8));
HXDLIN( 145)			int input34 = (input33 | (( (int)(bytes->b->__get(18)) ) << 16));
HXDLIN( 145)			int input35 = (input34 | (( (int)(bytes->b->__get(19)) ) << 24));
HXLINE( 222)			this->sendUpEvent(input08,input15,input25,input35);
HXLINE( 223)			return;
            		}
HXLINE( 230)		if ((funcindex2 == 3)) {
HXLINE( 145)			int bytes11 = ( (int)(bytes->b->__get(4)) );
HXDLIN( 145)			int input09 = (bytes11 | (( (int)(bytes->b->__get(5)) ) << 8));
HXDLIN( 145)			int input010 = (input09 | (( (int)(bytes->b->__get(6)) ) << 16));
HXDLIN( 145)			int input011 = (input010 | (( (int)(bytes->b->__get(7)) ) << 24));
HXDLIN( 145)			int bytes12 = ( (int)(bytes->b->__get(8)) );
HXDLIN( 145)			int input16 = (bytes12 | (( (int)(bytes->b->__get(9)) ) << 8));
HXDLIN( 145)			int input17 = (input16 | (( (int)(bytes->b->__get(10)) ) << 16));
HXDLIN( 145)			int input18 = (input17 | (( (int)(bytes->b->__get(11)) ) << 24));
HXDLIN( 145)			int bytes13 = ( (int)(bytes->b->__get(12)) );
HXDLIN( 145)			int input26 = (bytes13 | (( (int)(bytes->b->__get(13)) ) << 8));
HXDLIN( 145)			int input27 = (input26 | (( (int)(bytes->b->__get(14)) ) << 16));
HXDLIN( 145)			int input28 = (input27 | (( (int)(bytes->b->__get(15)) ) << 24));
HXDLIN( 145)			int bytes14 = ( (int)(bytes->b->__get(16)) );
HXDLIN( 145)			int input36 = (bytes14 | (( (int)(bytes->b->__get(17)) ) << 8));
HXDLIN( 145)			int input37 = (input36 | (( (int)(bytes->b->__get(18)) ) << 16));
HXDLIN( 145)			int input38 = (input37 | (( (int)(bytes->b->__get(19)) ) << 24));
HXDLIN( 145)			int bytes15 = ( (int)(bytes->b->__get(20)) );
HXDLIN( 145)			int input4 = (bytes15 | (( (int)(bytes->b->__get(21)) ) << 8));
HXDLIN( 145)			int input41 = (input4 | (( (int)(bytes->b->__get(22)) ) << 16));
HXDLIN( 145)			int input42 = (input41 | (( (int)(bytes->b->__get(23)) ) << 24));
HXLINE( 232)			this->sendMoveEvent(input011,input18,input28,input38,input42);
HXLINE( 233)			return;
            		}
HXLINE( 200)		if ((funcindex2 == 4)) {
HXLINE( 145)			int bytes16 = ( (int)(bytes->b->__get(4)) );
HXDLIN( 145)			int input012 = (bytes16 | (( (int)(bytes->b->__get(5)) ) << 8));
HXDLIN( 145)			int input013 = (input012 | (( (int)(bytes->b->__get(6)) ) << 16));
HXDLIN( 145)			int input014 = (input013 | (( (int)(bytes->b->__get(7)) ) << 24));
HXDLIN( 145)			int bytes17 = ( (int)(bytes->b->__get(8)) );
HXDLIN( 145)			int input19 = (bytes17 | (( (int)(bytes->b->__get(9)) ) << 8));
HXDLIN( 145)			int input110 = (input19 | (( (int)(bytes->b->__get(10)) ) << 16));
HXDLIN( 145)			int input111 = (input110 | (( (int)(bytes->b->__get(11)) ) << 24));
