...
static hx::StorageInfo Surface_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Surface_obj,touchStartListeners),HX_("touchStartListeners",dc,50,a8,67)},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Surface_obj,touchEndListeners),HX_("touchEndListeners",83,f4,39,35)},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Surface_obj,moveListeners),HX_("moveListeners",2e,f8,3d,0e)},
	{ hx::fsUnknown, 0, null()}
};
