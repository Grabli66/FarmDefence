...
HXLINE(  54)		::Array< unsigned char > second = this->bytes->b;
HXDLIN(  54)		int second1 = ( (int)(second->__get((position + 1))) );
HXLINE(  55)		position = (position + 2);
HXLINE(  56)		return ((first * 256) + second1);
            	}
...
HXLINE(  61)		::Array< unsigned char > second = this->bytes->b;
HXDLIN(  61)		int second1 = ( (int)(second->__get((position + 1))) );
HXLINE(  62)		position = (position + 2);
HXLINE(  63)		return ((second1 * 256) + first);
            	}
...
HXLINE(  68)		::Array< unsigned char > third = this->bytes->b;
HXDLIN(  68)		int third1 = ( (int)(third->__get((position + 1))) );
HXLINE(  69)		::Array< unsigned char > second = this->bytes->b;
HXDLIN(  69)		int second1 = ( (int)(second->__get((position + 2))) );
HXLINE(  70)		::Array< unsigned char > first = this->bytes->b;
HXDLIN(  70)		int first1 = ( (int)(first->__get((position + 3))) );
HXLINE(  71)		position = (position + 4);
HXLINE(  73)		return (((fourth + (third1 * 256)) + ((second1 * 256) * 256)) + (((first1 * 256) * 256) * 256));
            	}
...
HXLINE(  78)		::Array< unsigned char > third = this->bytes->b;
HXDLIN(  78)		int third1 = ( (int)(third->__get((position + 1))) );
HXLINE(  79)		::Array< unsigned char > second = this->bytes->b;
HXDLIN(  79)		int second1 = ( (int)(second->__get((position + 2))) );
HXLINE(  80)		::Array< unsigned char > first = this->bytes->b;
HXDLIN(  80)		int first1 = ( (int)(first->__get((position + 3))) );
HXLINE(  81)		position = (position + 4);
HXLINE(  83)		return (((first1 + (second1 * 256)) + ((third1 * 256) * 256)) + (((fourth * 256) * 256) * 256));
            	}
...
HXLINE(  88)		::Array< unsigned char > second = this->bytes->b;
HXDLIN(  88)		int second1 = ( (int)(second->__get((position + 1))) );
...
HXLINE(  92)		if ((sign == -1)) {
HXLINE(  92)			return ((-32767 + (first * 256)) + second1);
            		}
            		else {
HXLINE(  93)			return ((first * 256) + second1);
            		}
HXLINE(  92)		return 0;
            	}
...
HXLINE(  98)		::Array< unsigned char > second = this->bytes->b;
HXDLIN(  98)		int second1 = ( (int)(second->__get((position + 1))) );
HXLINE(  99)		int sign;
HXDLIN(  99)		if (((second1 & 128) == 0)) {
HXLINE(  99)			sign = 1;
            		}
            		else {
HXLINE(  99)			sign = -1;
            		}
HXLINE( 100)		second1 = (second1 & 127);
HXLINE( 101)		position = (position + 2);
HXLINE( 102)		if ((sign == -1)) {
HXLINE( 102)			return ((-32767 + (second1 * 256)) + first);
            		}
            		else {
HXLINE( 103)			return ((second1 * 256) + first);
            		}
HXLINE( 102)		return 0;
            	}
...
HXLINE( 108)		::Array< unsigned char > third = this->bytes->b;
HXDLIN( 108)		int third1 = ( (int)(third->__get((position + 1))) );
HXLINE( 109)		::Array< unsigned char > second = this->bytes->b;
HXDLIN( 109)		int second1 = ( (int)(second->__get((position + 2))) );
HXLINE( 110)		::Array< unsigned char > first = this->bytes->b;
HXDLIN( 110)		int first1 = ( (int)(first->__get((position + 3))) );
HXLINE( 111)		int sign;
HXDLIN( 111)		if (((first1 & 128) == 0)) {
HXLINE( 111)			sign = 1;
            		}
            		else {
HXLINE( 111)			sign = -1;
            		}
HXLINE( 112)		first1 = (first1 & 127);
HXLINE( 113)		position = (position + 4);
HXLINE( 114)		if ((sign == -1)) {
HXLINE( 114)			return (((((int)-2147483647 + fourth) + (third1 * 256)) + ((second1 * 256) * 256)) + (((first1 * 256) * 256) * 256));
            		}
            		else {
HXLINE( 115)			return (((fourth + (third1 * 256)) + ((second1 * 256) * 256)) + (((first1 * 256) * 256) * 256));
            		}
HXLINE( 114)		return 0;
            	}
...
HXLINE( 120)		::Array< unsigned char > third = this->bytes->b;
HXDLIN( 120)		int third1 = ( (int)(third->__get((position + 1))) );
HXLINE( 121)		::Array< unsigned char > second = this->bytes->b;
HXDLIN( 121)		int second1 = ( (int)(second->__get((position + 2))) );
HXLINE( 122)		::Array< unsigned char > first = this->bytes->b;
HXDLIN( 122)		int first1 = ( (int)(first->__get((position + 3))) );
HXLINE( 123)		int sign;
...
HXLINE( 126)			return (((((int)-2147483647 + first1) + (second1 * 256)) + ((third1 * 256) * 256)) + (((fourth * 256) * 256) * 256));
            		}
HXLINE( 127)		return (((first1 + (second1 * 256)) + ((third1 * 256) * 256)) + (((fourth * 256) * 256) * 256));
            	}
