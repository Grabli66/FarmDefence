...
HXDLIN(  42)				_hx_tmp((HX_("Unknown sound format: ",04,53,85,0f) + filename),hx::SourceInfo(HX_("kha/kore/Sound.hx",fc,c0,12,70),42,HX_("kha.kore.Sound",62,87,c4,f4),HX_("new",60,d0,53,00)));
            			}
            		}
            	}
