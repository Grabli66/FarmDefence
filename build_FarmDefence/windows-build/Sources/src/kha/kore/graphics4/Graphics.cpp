...
HX_LOCAL_STACK_FRAME(_hx_pos_cfbfed328d063821_525_begin,"kha.kore.graphics4.Graphics","begin",0x920e9958,"kha.kore.graphics4.Graphics.begin","kha/kore/graphics4/Graphics.hx",525,0xdc695dc0)
HX_LOCAL_STACK_FRAME(_hx_pos_cfbfed328d063821_541_beginFace,"kha.kore.graphics4.Graphics","beginFace",0xd9a10615,"kha.kore.graphics4.Graphics.beginFace","kha/kore/graphics4/Graphics.hx",541,0xdc695dc0)
HX_LOCAL_STACK_FRAME(_hx_pos_cfbfed328d063821_544_beginEye,"kha.kore.graphics4.Graphics","beginEye",0x06b692f9,"kha.kore.graphics4.Graphics.beginEye","kha/kore/graphics4/Graphics.hx",544,0xdc695dc0)
HX_LOCAL_STACK_FRAME(_hx_pos_cfbfed328d063821_548_end,"kha.kore.graphics4.Graphics","end",0x243a394a,"kha.kore.graphics4.Graphics.end","kha/kore/graphics4/Graphics.hx",548,0xdc695dc0)
HX_LOCAL_STACK_FRAME(_hx_pos_cfbfed328d063821_553_flush,"kha.kore.graphics4.Graphics","flush",0xe45411f3,"kha.kore.graphics4.Graphics.flush","kha/kore/graphics4/Graphics.hx",553,0xdc695dc0)
...
HXLINE( 505)			 ::kha::Image image1 = hx::TCast<  ::kha::Image >::cast(additionalRenderTargets->__get(0));
HXLINE( 506)			 ::kha::Image image2 = hx::TCast<  ::kha::Image >::cast(additionalRenderTargets->__get(1));
HXLINE( 507)			 ::kha::Image image3 = hx::TCast<  ::kha::Image >::cast(additionalRenderTargets->__get(2));
HXLINE( 508)			 ::kha::Image image4 = hx::TCast<  ::kha::Image >::cast(additionalRenderTargets->__get(3));
HXLINE( 509)			 ::kha::Image image5 = hx::TCast<  ::kha::Image >::cast(additionalRenderTargets->__get(4));
HXLINE( 510)			 ::kha::Image image6 = hx::TCast<  ::kha::Image >::cast(additionalRenderTargets->__get(5));
HXLINE( 511)			 ::kha::Image image7 = hx::TCast<  ::kha::Image >::cast(additionalRenderTargets->__get(6));
...
void Graphics_obj::begin(::Array< ::Dynamic> additionalRenderTargets){
            	HX_STACKFRAME(&_hx_pos_cfbfed328d063821_525_begin)
HXLINE( 526)		int win;
HXDLIN( 526)		if (hx::IsNull( this->window )) {
HXLINE( 526)			win = 0;
            		}
            		else {
HXLINE( 526)			win = ( (int)(this->window) );
            		}
HXLINE( 527)		if ((win != ::kha::kore::graphics4::Graphics_obj::lastWindow)) {
HXLINE( 528)			if ((::kha::kore::graphics4::Graphics_obj::lastWindow != -1)) {
HXLINE( 529)				Kore::Graphics4::begin(lastWindow);;
            			}
HXLINE( 531)			Kore::Graphics4::begin(win);;
HXLINE( 532)			::kha::kore::graphics4::Graphics_obj::lastWindow = win;
            		}
HXLINE( 534)		if (hx::IsNull( this->target )) {
HXLINE( 535)			this->renderToBackbuffer();
            		}
            		else {
HXLINE( 537)			this->renderToTexture(additionalRenderTargets);
            		}
            	}
...
void Graphics_obj::beginFace(int face){
            	HX_STACKFRAME(&_hx_pos_cfbfed328d063821_541_beginFace)
HXDLIN( 541)		Kore::Graphics4::setRenderTargetFace(renderTarget, face);
            	}
...
void Graphics_obj::beginEye(int eye){
            	HX_STACKFRAME(&_hx_pos_cfbfed328d063821_544_beginEye)
            	}
...
void Graphics_obj::end(){
            	HX_STACKFRAME(&_hx_pos_cfbfed328d063821_548_end)
            	}
...
void Graphics_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_cfbfed328d063821_553_flush)
...
static hx::StorageInfo Graphics_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::kha::Canvas*/ ,(int)offsetof(Graphics_obj,target),HX_("target",51,f3,ec,86)},
