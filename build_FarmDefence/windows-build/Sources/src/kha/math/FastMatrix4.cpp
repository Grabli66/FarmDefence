...
HXLINE( 136)		return  ::kha::math::FastMatrix4_obj::__alloc( HX_CTX ,( (float)(uw) ),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)(uh) ),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)((( (Float)((zf + zn)) ) / ( (Float)((zn - zf)) ))) ),( (float)((( (Float)(((2 * zf) * zn)) ) / ( (Float)((zn - zf)) ))) ),( (float)(0) ),( (float)(0) ),( (float)(-1) ),( (float)(0) ));
            	}
...
HXLINE( 146)		zaxis2->set_length(( (float)(1) ));
...
HXLINE( 149)		float _x2 = (xaxis->y * zaxis2->z);
...
HXDLIN( 149)		float yaxis_x = _x3;
HXDLIN( 149)		float yaxis_y = _y3;
HXDLIN( 149)		float yaxis_z = _z3;
...
HXLINE( 151)		return  ::kha::math::FastMatrix4_obj::__alloc( HX_CTX ,xaxis1,xaxis2,xaxis3,_hx_tmp2,yaxis_x,yaxis_y,yaxis_z,_hx_tmp5,_hx_tmp6,_hx_tmp7,_hx_tmp8,(_hx_tmp10 + (zaxis2->z * eye->z)),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)(1) ));
            	}
...
static hx::StorageInfo FastMatrix4_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_00),HX_("_00",1f,40,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_10),HX_("_10",fe,40,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_20),HX_("_20",dd,41,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_30),HX_("_30",bc,42,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_01),HX_("_01",20,40,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_11),HX_("_11",ff,40,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_21),HX_("_21",de,41,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_31),HX_("_31",bd,42,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_02),HX_("_02",21,40,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_12),HX_("_12",00,41,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_22),HX_("_22",df,41,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_32),HX_("_32",be,42,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_03),HX_("_03",22,40,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_13),HX_("_13",01,41,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_23),HX_("_23",e0,41,48,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastMatrix4_obj,_33),HX_("_33",bf,42,48,00)},
	{ hx::fsUnknown, 0, null()}
};
