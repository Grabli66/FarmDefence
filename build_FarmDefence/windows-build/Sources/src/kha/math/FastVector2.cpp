...
HXDLIN(  24)		return ( (float)(::Math_obj::sqrt(( (Float)((_hx_tmp + (this->y * this->y))) ))) );
            	}
...
static hx::StorageInfo FastVector2_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastVector2_obj,x),HX_("x",78,00,00,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastVector2_obj,y),HX_("y",79,00,00,00)},
	{ hx::fsUnknown, 0, null()}
};
