...
HXDLIN(  27)		return ( (float)(::Math_obj::sqrt(( (Float)((_hx_tmp1 + (this->z * this->z))) ))) );
            	}
...
static hx::StorageInfo FastVector3_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastVector3_obj,x),HX_("x",78,00,00,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastVector3_obj,y),HX_("y",79,00,00,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastVector3_obj,z),HX_("z",7a,00,00,00)},
	{ hx::fsUnknown, 0, null()}
};
