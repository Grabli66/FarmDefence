...
HXDLIN(  30)		return ( (float)(::Math_obj::sqrt(( (Float)((_hx_tmp2 + (this->w * this->w))) ))) );
            	}
...
static hx::StorageInfo FastVector4_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastVector4_obj,x),HX_("x",78,00,00,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastVector4_obj,y),HX_("y",79,00,00,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastVector4_obj,z),HX_("z",7a,00,00,00)},
	{hx::fsObject /*::cpp::Float32*/ ,(int)offsetof(FastVector4_obj,w),HX_("w",77,00,00,00)},
	{ hx::fsUnknown, 0, null()}
};
