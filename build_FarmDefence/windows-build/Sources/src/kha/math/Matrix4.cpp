...
HXLINE( 129)		return  ::kha::math::Matrix4_obj::__alloc( HX_CTX ,uw,( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),uh,( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),((zf + zn) / (zn - zf)),(((2 * zf) * zn) / (zn - zf)),( (Float)(0) ),( (Float)(0) ),( (Float)(-1) ),( (Float)(0) ));
            	}
...
HXLINE( 139)		zaxis2->set_length(( (Float)(1) ));
...
HXLINE( 142)		Float _x2 = (xaxis->y * zaxis2->z);
...
HXDLIN( 142)		Float yaxis_x = _x3;
HXDLIN( 142)		Float yaxis_y = _y3;
HXDLIN( 142)		Float yaxis_z = _z3;
...
HXLINE( 144)		return  ::kha::math::Matrix4_obj::__alloc( HX_CTX ,xaxis1,xaxis2,xaxis3,_hx_tmp2,yaxis_x,yaxis_y,yaxis_z,_hx_tmp5,_hx_tmp6,_hx_tmp7,_hx_tmp8,(_hx_tmp10 + (zaxis2->z * eye->z)),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
            	}
