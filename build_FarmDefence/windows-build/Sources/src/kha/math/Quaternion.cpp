...
HXLINE(  93)		return  ::kha::math::Matrix4_obj::__alloc( HX_CTX ,(1 - (yy + zz)),(xy - wz),(xz + wy),( (Float)(0) ),(xy + wz),(1 - (xx + zz)),(yz - wx),( (Float)(0) ),(xz - wy),(yz + wx),(1 - (xx + yy)),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
            	}
...
HXDLIN( 194)		this->scale((((Float)1.0) / this->get_length()));
            	}
...
HXLINE( 240)		if ((s22 < (-1 + SingularityRadius))) {
...
HXDLIN( 243)			Float _hx_tmp3 = (2 * (_hx_tmp1 + (_hx_tmp2 * Q->__get(A3))));
HXDLIN( 243)			result->z = ((S * D) * ::Math_obj::atan2(_hx_tmp3,(((ww1 + Q22) - Q11) - Q33)));
            		}
            		else {
HXLINE( 245)			if ((s22 > (1 - SingularityRadius))) {
...
HXDLIN( 248)				Float _hx_tmp6 = (2 * (_hx_tmp4 + (_hx_tmp5 * Q->__get(A3))));
...
HXDLIN( 251)				Float _hx_tmp9 = (-2 * (_hx_tmp8 - ((psign * Q->__get(A2)) * Q->__get(A3))));
...
HXDLIN( 253)				Float _hx_tmp12 = (2 * (_hx_tmp11 - ((psign * Q->__get(A1)) * Q->__get(A2))));
