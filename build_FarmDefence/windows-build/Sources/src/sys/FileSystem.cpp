...
HX_LOCAL_STACK_FRAME(_hx_pos_3ff4dc8597e20c42_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","C:\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/cpp/_std/sys/FileSystem.hx",38,0x246d1bfa)
namespace sys{
...
bool FileSystem_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_3ff4dc8597e20c42_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
HXLINE(  42)		s2->__SetField(HX_("atime",ee,10,db,26),::Date_obj::fromTime((((Float)1000.0) * s2->__Field(HX_("atime",ee,10,db,26),hx::paccDynamic))),hx::paccDynamic);
HXLINE(  43)		s2->__SetField(HX_("mtime",fa,06,aa,0f),::Date_obj::fromTime((((Float)1000.0) * s2->__Field(HX_("mtime",fa,06,aa,0f),hx::paccDynamic))),hx::paccDynamic);
HXLINE(  44)		s2->__SetField(HX_("ctime",f0,39,a8,4d),::Date_obj::fromTime((((Float)1000.0) * s2->__Field(HX_("ctime",f0,39,a8,4d),hx::paccDynamic))),hx::paccDynamic);
HXLINE(  45)		return s2;
            	}
