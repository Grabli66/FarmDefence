...
void main()
{
    ...
    vec3 _640 = pow(ImageTexture_store.xyz, vec3(2.2000000476837158203125));
    ImageTexture_store = vec4(_640.x, _640.y, _640.z, ImageTexture_store.w);
    ...
    if (receiveShadow)
    {
        ...
        else
        {
            ...
            {
                vec3 param = -l;
                float _830 = PCFCube(shadowMapCube, lp, param, shadowsBias, lightProj, n);
                visibility *= _830;
            }
        }
    }
    ...
    vec3 _913 = tonemapFilmic(fragColor.xyz);
